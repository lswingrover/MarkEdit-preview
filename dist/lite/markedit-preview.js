...
`;break}return r};bn.prototype.render=function(e,n,t){let r="";const o=this.rules;for(let u=0,c=e.length;u<c;u++){const a=e[u].type;a==="inline"?r+=this.renderInline(e[u].children,n,t):typeof o[a]<"u"?r+=o[a](e,u,n,t,this):r+=this.renderToken(e,u,n,t)}return r};function ie(){this.__rules__=[],this.__cache__=null}ie.prototype.__find__=function(e){for(let n=0;n<this.__rules__.length;n++)if(this.__rules__[n].name===e)return n;return-1};ie.prototype.__compile__=function(){const e=this,n=[""];e.__rules__.forEach(function(t){t.enabled&&t.alt.forEach(function(r){n.indexOf(r)<0&&n.push(r)})}),e.__cache__={},n.forEach(function(t){e.__cache__[t]=[],e.__rules__.forEach(function(r){r.enabled&&(t&&r.alt.indexOf(t)<0||e.__cache__[t].push(r.fn))})})};ie.prototype.at=function(e,n,t){const r=this.__find__(e),o=t||{};if(r===-1)throw new Error("Parser rule not found: "+e);this.__rules__[r].fn=n,this.__rules__[r].alt=o.alt||[],this.__cache__=null};ie.prototype.before=function(e,n,t,r){const o=this.__find__(e),u=r||{};if(o===-1)throw new Error("Parser rule not found: "+e);this.__rules__.splice(o,0,{name:n,enabled:!0,fn:t,alt:u.alt||[]}),this.__cache__=null};ie.prototype.after=function(e,n,t,r){const o=this.__find__(e),u=r||{};if(o===-1)throw new Error("Parser rule not found: "+e);this.__rules__.splice(o+1,0,{name:n,enabled:!0,fn:t,alt:u.alt||[]}),this.__cache__=null};ie.prototype.push=function(e,n,t){const r=t||{};this.__rules__.push({name:e,enabled:!0,fn:n,alt:r.alt||[]}),this.__cache__=null};ie.prototype.enable=function(e,n){Array.isArray(e)||(e=[e]);const t=[];return e.forEach(function(r){const o=this.__find__(r);if(o<0){if(n)return;throw new Error("Rules manager: invalid rule name "+r)}this.__rules__[o].enabled=!0,t.push(r)},this),this.__cache__=null,t};ie.prototype.enableOnly=function(e,n){Array.isArray(e)||(e=[e]),this.__rules__.forEach(function(t){t.enabled=!1}),this.enable(e,n)};ie.prototype.disable=function(e,n){Array.isArray(e)||(e=[e]);const t=[];return e.forEach(function(r){const o=this.__find__(r);if(o<0){if(n)return;throw new Error("Rules manager: invalid rule name "+r)}this.__rules__[o].enabled=!1,t.push(r)},this),this.__cache__=null,t};ie.prototype.getRules=function(e){return this.__cache__===null&&this.__compile__(),this.__cache__[e]||[]};function ke(e,n,t){this.type=e,this.tag=n,this.attrs=null,this.map=null,this.nesting=t,this.level=0,this.children=null,this.content="",this.markup="",this.info="",this.meta=null,this.block=!1,this.hidden=!1}ke.prototype.attrIndex=function(n){if(!this.attrs)return-1;const t=this.attrs;for(let r=0,o=t.length;r<o;r++)if(t[r][0]===n)return r;return-1};ke.prototype.attrPush=function(n){this.attrs?this.attrs.push(n):this.attrs=[n]};ke.prototype.attrSet=function(n,t){const r=this.attrIndex(n),o=[n,t];r<0?this.attrPush(o):this.attrs[r]=o};ke.prototype.attrGet=function(n){const t=this.attrIndex(n);let r=null;return t>=0&&(r=this.attrs[t][1]),r};ke.prototype.attrJoin=function(n,t){const r=this.attrIndex(n);r<0?this.attrPush([n,t]):this.attrs[r][1]=this.attrs[r][1]+" "+t};function Zo(e,n,t){this.src=e,this.env=t,this.tokens=[],this.inlineMode=!1,this.md=n}Zo.prototype.Token=ke;const Ca=/\r\n?|\n/g,_a=/\0/g;function Ea(e){let n;n=e.src.replace(Ca,`
`),n=n.replace(_a,"�"),e.src=n}function Aa(e){let n;e.inlineMode?(n=new e.Token("inline","",0),n.content=e.src,n.map=[0,1],n.children=[],e.tokens.push(n)):e.md.block.parse(e.src,e.md,e.env,e.tokens)}function Sa(e){const n=e.tokens;for(let t=0,r=n.length;t<r;t++){const o=n[t];o.type==="inline"&&e.md.inline.parse(o.content,e.md,e.env,o.children)}}function Da(e){return/^<a[>\s]/i.test(e)}function Ta(e){return/^<\/a\s*>/i.test(e)}function Fa(e){const n=e.tokens;if(e.md.options.linkify)for(let t=0,r=n.length;t<r;t++){if(n[t].type!=="inline"||!e.md.linkify.pretest(n[t].content))continue;let o=n[t].children,u=0;for(let c=o.length-1;c>=0;c--){const a=o[c];if(a.type==="link_close"){for(c--;o[c].level!==a.level&&o[c].type!=="link_open";)c--;continue}if(a.type==="html_inline"&&(Da(a.content)&&u>0&&u--,Ta(a.content)&&u++),!(u>0)&&a.type==="text"&&e.md.linkify.test(a.content)){const s=a.content;let d=e.md.linkify.match(s);const p=[];let l=a.level,f=0;d.length>0&&d[0].index===0&&c>0&&o[c-1].type==="text_special"&&(d=d.slice(1));for(let h=0;h<d.length;h++){const b=d[h].url,g=e.md.normalizeLink(b);if(!e.md.validateLink(g))continue;let k=d[h].text;d[h].schema?d[h].schema==="mailto:"&&!/^mailto:/i.test(k)?k=e.md.normalizeLinkText("mailto:"+k).replace(/^mailto:/,""):k=e.md.normalizeLinkText(k):k=e.md.normalizeLinkText("http://"+k).replace(/^http:\/\//,"");const y=d[h].index;if(y>f){const R=new e.Token("text","",0);R.content=s.slice(f,y),R.level=l,p.push(R)}const w=new e.Token("link_open","a",1);w.attrs=[["href",g]],w.level=l++,w.markup="linkify",w.info="auto",p.push(w);const E=new e.Token("text","",0);E.content=k,E.level=l,p.push(E);const A=new e.Token("link_close","a",-1);A.level=--l,A.markup="linkify",A.info="auto",p.push(A),f=d[h].lastIndex}if(f<s.length){const h=new e.Token("text","",0);h.content=s.slice(f),h.level=l,p.push(h)}n[t].children=o=Uo(o,c,p)}}}}const Wo=/\+-|\.\.|\?\?\?\?|!!!!|,,|--/,Ma=/\((c|tm|r)\)/i,Ia=/\((c|tm|r)\)/ig,Ra={c:"©",r:"®",tm:"™"};function La(e,n){return Ra[n.toLowerCase()]}function Na(e){let n=0;for(let t=e.length-1;t>=0;t--){const r=e[t];r.type==="text"&&!n&&(r.content=r.content.replace(Ia,La)),r.type==="link_open"&&r.info==="auto"&&n--,r.type==="link_close"&&r.info==="auto"&&n++}}function Oa(e){let n=0;for(let t=e.length-1;t>=0;t--){const r=e[t];r.type==="text"&&!n&&Wo.test(r.content)&&(r.content=r.content.replace(/\+-/g,"±").replace(/\.{2,}/g,"…").replace(/([?!])…/g,"$1..").replace(/([?!]){4,}/g,"$1$1$1").replace(/,{2,}/g,",").replace(/(^|[^-])---(?=[^-]|$)/mg,"$1—").replace(/(^|\s)--(?=\s|$)/mg,"$1–").replace(/(^|[^-\s])--(?=[^-\s]|$)/mg,"$1–")),r.type==="link_open"&&r.info==="auto"&&n--,r.type==="link_close"&&r.info==="auto"&&n++}}function Pa(e){let n;if(e.md.options.typographer)for(n=e.tokens.length-1;n>=0;n--)e.tokens[n].type==="inline"&&(Ma.test(e.tokens[n].content)&&Na(e.tokens[n].children),Wo.test(e.tokens[n].content)&&Oa(e.tokens[n].children))}const Ba=/['"]/,oo=/['"]/g,uo="’";function tt(e,n,t,r){e[n]||(e[n]=[]),e[n].push({pos:t,ch:r})}function za(e,n){let t="",r=0;n.sort((o,u)=>o.pos-u.pos);for(let o=0;o<n.length;o++){const u=n[o];t+=e.slice(r,u.pos)+u.ch,r=u.pos+1}return t+e.slice(r)}function qa(e,n){let t;const r=[],o={};for(let u=0;u<e.length;u++){const c=e[u],a=e[u].level;for(t=r.length-1;t>=0&&!(r[t].level<=a);t--);if(r.length=t+1,c.type!=="text")continue;const s=c.content;let d=0;const p=s.length;e:for(;d<p;){oo.lastIndex=d;const l=oo.exec(s);if(!l)break;let f=!0,h=!0;d=l.index+1;const b=l[0]==="'";let g=32;if(l.index-1>=0)g=s.charCodeAt(l.index-1);else for(t=u-1;t>=0&&!(e[t].type==="softbreak"||e[t].type==="hardbreak");t--)if(e[t].content){g=e[t].content.charCodeAt(e[t].content.length-1);break}let k=32;if(d<p)k=s.charCodeAt(d);else for(t=u+1;t<e.length&&!(e[t].type==="softbreak"||e[t].type==="hardbreak");t++)if(e[t].content){k=e[t].content.charCodeAt(0);break}const y=In(g)||Mn(g),w=In(k)||Mn(k),E=Fn(g),A=Fn(k);if(A?f=!1:w&&(E||y||(f=!1)),E?h=!1:y&&(A||w||(h=!1)),k===34&&l[0]==='"'&&g>=48&&g<=57&&(h=f=!1),f&&h&&(f=y,h=w),!f&&!h){b&&tt(o,u,l.index,uo);continue}if(h)for(t=r.length-1;t>=0;t--){let R=r[t];if(r[t].level<a)break;if(R.single===b&&r[t].level===a){R=r[t];let N,j;b?(N=n.md.options.quotes[2],j=n.md.options.quotes[3]):(N=n.md.options.quotes[0],j=n.md.options.quotes[1]),tt(o,u,l.index,j),tt(o,R.token,R.pos,N),r.length=t;continue e}}f?r.push({token:u,pos:l.index,single:b,level:a}):h&&b&&tt(o,u,l.index,uo)}}Object.keys(o).forEach(function(u){e[u].content=za(e[u].content,o[u])})}function Ha(e){if(e.md.options.typographer)for(let n=e.tokens.length-1;n>=0;n--)e.tokens[n].type!=="inline"||!Ba.test(e.tokens[n].content)||qa(e.tokens[n].children,e)}function ja(e){let n,t;const r=e.tokens,o=r.length;for(let u=0;u<o;u++){if(r[u].type!=="inline")continue;const c=r[u].children,a=c.length;for(n=0;n<a;n++)c[n].type==="text_special"&&(c[n].type="text");for(n=t=0;n<a;n++)c[n].type==="text"&&n+1<a&&c[n+1].type==="text"?c[n+1].content=c[n].content+c[n+1].content:(n!==t&&(c[t]=c[n]),t++);n!==t&&(c.length=t)}}const Bt=[["normalize",Ea],["block",Aa],["inline",Sa],["linkify",Fa],["replacements",Pa],["smartquotes",Ha],["text_join",ja]];function _r(){this.ruler=new ie;for(let e=0;e<Bt.length;e++)this.ruler.push(Bt[e][0],Bt[e][1])}_r.prototype.process=function(e){const n=this.ruler.getRules("");for(let t=0,r=n.length;t<r;t++)n[t](e)};_r.prototype.State=Zo;function we(e,n,t,r){this.src=e,this.md=n,this.env=t,this.tokens=r,this.bMarks=[],this.eMarks=[],this.tShift=[],this.sCount=[],this.bsCount=[],this.blkIndent=0,this.line=0,this.lineMax=0,this.tight=!1,this.ddIndent=-1,this.listIndent=-1,this.parentType="root",this.level=0;const o=this.src;for(let u=0,c=0,a=0,s=0,d=o.length,p=!1;c<d;c++){const l=o.charCodeAt(c);if(!p)if(V(l)){a++,l===9?s+=4-s%4:s++;continue}else p=!0;(l===10||c===d-1)&&(l!==10&&c++,this.bMarks.push(u),this.eMarks.push(c),this.tShift.push(a),this.sCount.push(s),this.bsCount.push(0),p=!1,a=0,s=0,u=c+1)}this.bMarks.push(o.length),this.eMarks.push(o.length),this.tShift.push(0),this.sCount.push(0),this.bsCount.push(0),this.lineMax=this.bMarks.length-1}we.prototype.push=function(e,n,t){const r=new ke(e,n,t);return r.block=!0,t<0&&this.level--,r.level=this.level,t>0&&this.level++,this.tokens.push(r),r};we.prototype.isEmpty=function(n){return this.bMarks[n]+this.tShift[n]>=this.eMarks[n]};we.prototype.skipEmptyLines=function(n){for(let t=this.lineMax;n<t&&!(this.bMarks[n]+this.tShift[n]<this.eMarks[n]);n++);return n};we.prototype.skipSpaces=function(n){for(let t=this.src.length;n<t;n++){const r=this.src.charCodeAt(n);if(!V(r))break}return n};we.prototype.skipSpacesBack=function(n,t){if(n<=t)return n;for(;n>t;)if(!V(this.src.charCodeAt(--n)))return n+1;return n};we.prototype.skipChars=function(n,t){for(let r=this.src.length;n<r&&this.src.charCodeAt(n)===t;n++);return n};we.prototype.skipCharsBack=function(n,t,r){if(n<=r)return n;for(;n>r;)if(t!==this.src.charCodeAt(--n))return n+1;return n};we.prototype.getLines=function(n,t,r,o){if(n>=t)return"";const u=new Array(t-n);for(let c=0,a=n;a<t;a++,c++){let s=0;const d=this.bMarks[a];let p=d,l;for(a+1<t||o?l=this.eMarks[a]+1:l=this.eMarks[a];p<l&&s<r;){const f=this.src.charCodeAt(p);if(V(f))f===9?s+=4-(s+this.bsCount[a])%4:s++;else if(p-d<this.tShift[a])s++;else break;p++}s>r?u[c]=new Array(s-r+1).join(" ")+this.src.slice(p,l):u[c]=this.src.slice(p,l)}return u.join("")};we.prototype.Token=ke;const $a=65536;function zt(e,n){const t=e.bMarks[n]+e.tShift[n],r=e.eMarks[n];return e.src.slice(t,r)}function io(e){const n=[],t=e.length;let r=0,o=e.charCodeAt(r),u=!1,c=0,a="";for(;r<t;)o===124&&(u?(a+=e.substring(c,r-1),c=r):(n.push(a+e.substring(c,r)),a="",c=r+1)),u=o===92,r++,o=e.charCodeAt(r);return n.push(a+e.substring(c)),n}function Ua(e,n,t,r){if(n+2>t)return!1;let o=n+1;if(e.sCount[o]<e.blkIndent||e.sCount[o]-e.blkIndent>=4)return!1;let u=e.bMarks[o]+e.tShift[o];if(u>=e.eMarks[o])return!1;const c=e.src.charCodeAt(u++);if(c!==124&&c!==45&&c!==58||u>=e.eMarks[o])return!1;const a=e.src.charCodeAt(u++);if(a!==124&&a!==45&&a!==58&&!V(a)||c===45&&V(a))return!1;for(;u<e.eMarks[o];){const A=e.src.charCodeAt(u);if(A!==124&&A!==45&&A!==58&&!V(A))return!1;u++}let s=zt(e,n+1),d=s.split("|");const p=[];for(let A=0;A<d.length;A++){const R=d[A].trim();if(!R){if(A===0||A===d.length-1)continue;return!1}if(!/^:?-+:?$/.test(R))return!1;R.charCodeAt(R.length-1)===58?p.push(R.charCodeAt(0)===58?"center":"right"):R.charCodeAt(0)===58?p.push("left"):p.push("")}if(s=zt(e,n).trim(),s.indexOf("|")===-1||e.sCount[n]-e.blkIndent>=4)return!1;d=io(s),d.length&&d[0]===""&&d.shift(),d.length&&d[d.length-1]===""&&d.pop();const l=d.length;if(l===0||l!==p.length)return!1;if(r)return!0;const f=e.parentType;e.parentType="table";const h=e.md.block.ruler.getRules("blockquote"),b=e.push("table_open","table",1),g=[n,0];b.map=g;const k=e.push("thead_open","thead",1);k.map=[n,n+1];const y=e.push("tr_open","tr",1);y.map=[n,n+1];for(let A=0;A<d.length;A++){const R=e.push("th_open","th",1);p[A]&&(R.attrs=[["style","text-align:"+p[A]]]);const N=e.push("inline","",0);N.content=d[A].trim(),N.children=[],e.push("th_close","th",-1)}e.push("tr_close","tr",-1),e.push("thead_close","thead",-1);let w,E=0;for(o=n+2;o<t&&!(e.sCount[o]<e.blkIndent);o++){let A=!1;for(let N=0,j=h.length;N<j;N++)if(h[N](e,o,t,!0)){A=!0;break}if(A||(s=zt(e,o).trim(),!s)||e.sCount[o]-e.blkIndent>=4||(d=io(s),d.length&&d[0]===""&&d.shift(),d.length&&d[d.length-1]===""&&d.pop(),E+=l-d.length,E>$a))break;if(o===n+2){const N=e.push("tbody_open","tbody",1);N.map=w=[n+2,0]}const R=e.push("tr_open","tr",1);R.map=[o,o+1];for(let N=0;N<l;N++){const j=e.push("td_open","td",1);p[N]&&(j.attrs=[["style","text-align:"+p[N]]]);const U=e.push("inline","",0);U.content=d[N]?d[N].trim():"",U.children=[],e.push("td_close","td",-1)}e.push("tr_close","tr",-1)}return w&&(e.push("tbody_close","tbody",-1),w[1]=o),e.push("table_close","table",-1),g[1]=o,e.parentType=f,e.line=o,!0}function Ga(e,n,t){if(e.sCount[n]-e.blkIndent<4)return!1;let r=n+1,o=r;for(;r<t;){if(e.isEmpty(r)){r++;continue}if(e.sCount[r]-e.blkIndent>=4){r++,o=r;continue}break}e.line=o;const u=e.push("code_block","code",0);return u.content=e.getLines(n,o,4+e.blkIndent,!1)+`
`,u.map=[n,e.line],!0}function Va(e,n,t,r){let o=e.bMarks[n]+e.tShift[n],u=e.eMarks[n];if(e.sCount[n]-e.blkIndent>=4||o+3>u)return!1;const c=e.src.charCodeAt(o);if(c!==126&&c!==96)return!1;let a=o;o=e.skipChars(o,c);let s=o-a;if(s<3)return!1;const d=e.src.slice(a,o),p=e.src.slice(o,u);if(c===96&&p.indexOf(String.fromCharCode(c))>=0)return!1;if(r)return!0;let l=n,f=!1;for(;l++,!(l>=t||(o=a=e.bMarks[l]+e.tShift[l],u=e.eMarks[l],o<u&&e.sCount[l]<e.blkIndent));)if(e.src.charCodeAt(o)===c&&!(e.sCount[l]-e.blkIndent>=4)&&(o=e.skipChars(o,c),!(o-a<s)&&(o=e.skipSpaces(o),!(o<u)))){f=!0;break}s=e.sCount[n],e.line=l+(f?1:0);const h=e.push("fence","code",0);return h.info=p,h.content=e.getLines(n+1,l,s,!0),h.markup=d,h.map=[n,e.line],!0}function Za(e,n,t,r){let o=e.bMarks[n]+e.tShift[n],u=e.eMarks[n];const c=e.lineMax;if(e.sCount[n]-e.blkIndent>=4||e.src.charCodeAt(o)!==62)return!1;if(r)return!0;const a=[],s=[],d=[],p=[],l=e.md.block.ruler.getRules("blockquote"),f=e.parentType;e.parentType="blockquote";let h=!1,b;for(b=n;b<t;b++){const E=e.sCount[b]<e.blkIndent;if(o=e.bMarks[b]+e.tShift[b],u=e.eMarks[b],o>=u)break;if(e.src.charCodeAt(o++)===62&&!E){let R=e.sCount[b]+1,N,j;e.src.charCodeAt(o)===32?(o++,R++,j=!1,N=!0):e.src.charCodeAt(o)===9?(N=!0,(e.bsCount[b]+R)%4===3?(o++,R++,j=!1):j=!0):N=!1;let U=R;for(a.push(e.bMarks[b]),e.bMarks[b]=o;o<u;){const Q=e.src.charCodeAt(o);if(V(Q))Q===9?U+=4-(U+e.bsCount[b]+(j?1:0))%4:U++;else break;o++}h=o>=u,s.push(e.bsCount[b]),e.bsCount[b]=e.sCount[b]+1+(N?1:0),d.push(e.sCount[b]),e.sCount[b]=U-R,p.push(e.tShift[b]),e.tShift[b]=o-e.bMarks[b];continue}if(h)break;let A=!1;for(let R=0,N=l.length;R<N;R++)if(l[R](e,b,t,!0)){A=!0;break}if(A){e.lineMax=b,e.blkIndent!==0&&(a.push(e.bMarks[b]),s.push(e.bsCount[b]),p.push(e.tShift[b]),d.push(e.sCount[b]),e.sCount[b]-=e.blkIndent);break}a.push(e.bMarks[b]),s.push(e.bsCount[b]),p.push(e.tShift[b]),d.push(e.sCount[b]),e.sCount[b]=-1}const g=e.blkIndent;e.blkIndent=0;const k=e.push("blockquote_open","blockquote",1);k.markup=">";const y=[n,0];k.map=y,e.md.block.tokenize(e,n,b);const w=e.push("blockquote_close","blockquote",-1);w.markup=">",e.lineMax=c,e.parentType=f,y[1]=e.line;for(let E=0;E<p.length;E++)e.bMarks[E+n]=a[E],e.tShift[E+n]=p[E],e.sCount[E+n]=d[E],e.bsCount[E+n]=s[E];return e.blkIndent=g,!0}function Wa(e,n,t,r){const o=e.eMarks[n];if(e.sCount[n]-e.blkIndent>=4)return!1;let u=e.bMarks[n]+e.tShift[n];const c=e.src.charCodeAt(u++);if(c!==42&&c!==45&&c!==95)return!1;let a=1;for(;u<o;){const d=e.src.charCodeAt(u++);if(d!==c&&!V(d))return!1;d===c&&a++}if(a<3)return!1;if(r)return!0;e.line=n+1;const s=e.push("hr","hr",0);return s.map=[n,e.line],s.markup=Array(a+1).join(String.fromCharCode(c)),!0}function ao(e,n){const t=e.eMarks[n];let r=e.bMarks[n]+e.tShift[n];const o=e.src.charCodeAt(r++);if(o!==42&&o!==45&&o!==43)return-1;if(r<t){const u=e.src.charCodeAt(r);if(!V(u))return-1}return r}function co(e,n){const t=e.bMarks[n]+e.tShift[n],r=e.eMarks[n];let o=t;if(o+1>=r)return-1;let u=e.src.charCodeAt(o++);if(u<48||u>57)return-1;for(;;){if(o>=r)return-1;if(u=e.src.charCodeAt(o++),u>=48&&u<=57){if(o-t>=10)return-1;continue}if(u===41||u===46)break;return-1}return o<r&&(u=e.src.charCodeAt(o),!V(u))?-1:o}function Ka(e,n){const t=e.level+2;for(let r=n+2,o=e.tokens.length-2;r<o;r++)e.tokens[r].level===t&&e.tokens[r].type==="paragraph_open"&&(e.tokens[r+2].hidden=!0,e.tokens[r].hidden=!0,r+=2)}function Ya(e,n,t,r){let o,u,c,a,s=n,d=!0;if(e.sCount[s]-e.blkIndent>=4||e.listIndent>=0&&e.sCount[s]-e.listIndent>=4&&e.sCount[s]<e.blkIndent)return!1;let p=!1;r&&e.parentType==="paragraph"&&e.sCount[s]>=e.blkIndent&&(p=!0);let l,f,h;if((h=co(e,s))>=0){if(l=!0,c=e.bMarks[s]+e.tShift[s],f=Number(e.src.slice(c,h-1)),p&&f!==1)return!1}else if((h=ao(e,s))>=0)l=!1;else return!1;if(p&&e.skipSpaces(h)>=e.eMarks[s])return!1;if(r)return!0;const b=e.src.charCodeAt(h-1),g=e.tokens.length;l?(a=e.push("ordered_list_open","ol",1),f!==1&&(a.attrs=[["start",f]])):a=e.push("bullet_list_open","ul",1);const k=[s,0];a.map=k,a.markup=String.fromCharCode(b);let y=!1;const w=e.md.block.ruler.getRules("list"),E=e.parentType;for(e.parentType="list";s<t;){u=h,o=e.eMarks[s];const A=e.sCount[s]+h-(e.bMarks[s]+e.tShift[s]);let R=A;for(;u<o;){const de=e.src.charCodeAt(u);if(de===9)R+=4-(R+e.bsCount[s])%4;else if(de===32)R++;else break;u++}const N=u;let j;N>=o?j=1:j=R-A,j>4&&(j=1);const U=A+j;a=e.push("list_item_open","li",1),a.markup=String.fromCharCode(b);const Q=[s,0];a.map=Q,l&&(a.info=e.src.slice(c,h-1));const se=e.tight,Ce=e.tShift[s],kn=e.sCount[s],ze=e.listIndent;if(e.listIndent=e.blkIndent,e.blkIndent=U,e.tight=!0,e.tShift[s]=N-e.bMarks[s],e.sCount[s]=R,N>=o&&e.isEmpty(s+1)?e.line=Math.min(e.line+2,t):e.md.block.tokenize(e,s,t,!0),(!e.tight||y)&&(d=!1),y=e.line-s>1&&e.isEmpty(e.line-1),e.blkIndent=e.listIndent,e.listIndent=ze,e.tShift[s]=Ce,e.sCount[s]=kn,e.tight=se,a=e.push("list_item_close","li",-1),a.markup=String.fromCharCode(b),s=e.line,Q[1]=s,s>=t||e.sCount[s]<e.blkIndent||e.sCount[s]-e.blkIndent>=4)break;let qe=!1;for(let de=0,X=w.length;de<X;de++)if(w[de](e,s,t,!0)){qe=!0;break}if(qe)break;if(l){if(h=co(e,s),h<0)break;c=e.bMarks[s]+e.tShift[s]}else if(h=ao(e,s),h<0)break;if(b!==e.src.charCodeAt(h-1))break}return l?a=e.push("ordered_list_close","ol",-1):a=e.push("bullet_list_close","ul",-1),a.markup=String.fromCharCode(b),k[1]=s,e.line=s,e.parentType=E,d&&Ka(e,g),!0}function Ja(e,n,t,r){let o=e.bMarks[n]+e.tShift[n],u=e.eMarks[n],c=n+1;if(e.sCount[n]-e.blkIndent>=4||e.src.charCodeAt(o)!==91)return!1;function a(w){const E=e.lineMax;if(w>=E||e.isEmpty(w))return null;let A=!1;if(e.sCount[w]-e.blkIndent>3&&(A=!0),e.sCount[w]<0&&(A=!0),!A){const j=e.md.block.ruler.getRules("reference"),U=e.parentType;e.parentType="reference";let Q=!1;for(let se=0,Ce=j.length;se<Ce;se++)if(j[se](e,w,E,!0)){Q=!0;break}if(e.parentType=U,Q)return null}const R=e.bMarks[w]+e.tShift[w],N=e.eMarks[w];return e.src.slice(R,N+1)}let s=e.src.slice(o,u+1);u=s.length;let d=-1;for(o=1;o<u;o++){const w=s.charCodeAt(o);if(w===91)return!1;if(w===93){d=o;break}else if(w===10){const E=a(c);E!==null&&(s+=E,u=s.length,c++)}else if(w===92&&(o++,o<u&&s.charCodeAt(o)===10)){const E=a(c);E!==null&&(s+=E,u=s.length,c++)}}if(d<0||s.charCodeAt(d+1)!==58)return!1;for(o=d+2;o<u;o++){const w=s.charCodeAt(o);if(w===10){const E=a(c);E!==null&&(s+=E,u=s.length,c++)}else if(!V(w))break}const p=e.md.helpers.parseLinkDestination(s,o,u);if(!p.ok)return!1;const l=e.md.normalizeLink(p.str);if(!e.md.validateLink(l))return!1;o=p.pos;const f=o,h=c,b=o;for(;o<u;o++){const w=s.charCodeAt(o);if(w===10){const E=a(c);E!==null&&(s+=E,u=s.length,c++)}else if(!V(w))break}let g=e.md.helpers.parseLinkTitle(s,o,u);for(;g.can_continue;){const w=a(c);if(w===null)break;s+=w,o=u,u=s.length,c++,g=e.md.helpers.parseLinkTitle(s,o,u,g)}let k;for(o<u&&b!==o&&g.ok?(k=g.str,o=g.pos):(k="",o=f,c=h);o<u;){const w=s.charCodeAt(o);if(!V(w))break;o++}if(o<u&&s.charCodeAt(o)!==10&&k)for(k="",o=f,c=h;o<u;){const w=s.charCodeAt(o);if(!V(w))break;o++}if(o<u&&s.charCodeAt(o)!==10)return!1;const y=yt(s.slice(1,d));return y?(r||(typeof e.env.references>"u"&&(e.env.references={}),typeof e.env.references[y]>"u"&&(e.env.references[y]={title:k,href:l}),e.line=c),!0):!1}const Qa=["address","article","aside","base","basefont","blockquote","body","caption","center","col","colgroup","dd","details","dialog","dir","div","dl","dt","fieldset","figcaption","figure","footer","form","frame","frameset","h1","h2","h3","h4","h5","h6","head","header","hr","html","iframe","legend","li","link","main","menu","menuitem","nav","noframes","ol","optgroup","option","p","param","search","section","summary","table","tbody","td","tfoot","th","thead","title","tr","track","ul"],Xa="[a-zA-Z_:][a-zA-Z0-9:._-]*",ec="[^\"'=<>`\\x00-\\x20]+",nc="'[^']*'",tc='"[^"]*"',rc="(?:"+ec+"|"+nc+"|"+tc+")",oc="(?:\\s+"+Xa+"(?:\\s*=\\s*"+rc+")?)",Ko="<[A-Za-z][A-Za-z0-9\\-]*"+oc+"*\\s*\\/?>",Yo="<\\/[A-Za-z][A-Za-z0-9\\-]*\\s*>",uc="<!---?>|<!--(?:[^-]|-[^-]|--[^>])*-->",ic="<[?][\\s\\S]*?[?]>",ac="<![A-Za-z][^>]*>",cc="<!\\[CDATA\\[[\\s\\S]*?\\]\\]>",lc=new RegExp("^(?:"+Ko+"|"+Yo+"|"+uc+"|"+ic+"|"+ac+"|"+cc+")"),sc=new RegExp("^(?:"+Ko+"|"+Yo+")"),je=[[/^<(script|pre|style|textarea)(?=(\s|>|$))/i,/<\/(script|pre|style|textarea)>/i,!0],[/^<!--/,/-->/,!0],[/^<\?/,/\?>/,!0],[/^<![A-Z]/,/>/,!0],[/^<!\[CDATA\[/,/\]\]>/,!0],[new RegExp("^</?("+Qa.join("|")+")(?=(\\s|/?>|$))","i"),/^$/,!0],[new RegExp(sc.source+"\\s*$"),/^$/,!1]];function dc(e,n,t,r){let o=e.bMarks[n]+e.tShift[n],u=e.eMarks[n];if(e.sCount[n]-e.blkIndent>=4||!e.md.options.html||e.src.charCodeAt(o)!==60)return!1;let c=e.src.slice(o,u),a=0;for(;a<je.length&&!je[a][0].test(c);a++);if(a===je.length)return!1;if(r)return je[a][2];let s=n+1;const d=je[a][1].test("");if(!je[a][1].test(c)){for(;s<t&&!(e.sCount[s]<e.blkIndent&&(d||!e.isEmpty(s)));s++)if(o=e.bMarks[s]+e.tShift[s],u=e.eMarks[s],c=e.src.slice(o,u),je[a][1].test(c)){c.length!==0&&s++;break}}e.line=s;const p=e.push("html_block","",0);return p.map=[n,s],p.content=e.getLines(n,s,e.blkIndent,!0),!0}function fc(e,n,t,r){let o=e.bMarks[n]+e.tShift[n],u=e.eMarks[n];if(e.sCount[n]-e.blkIndent>=4)return!1;let c=e.src.charCodeAt(o);if(c!==35||o>=u)return!1;let a=1;for(c=e.src.charCodeAt(++o);c===35&&o<u&&a<=6;)a++,c=e.src.charCodeAt(++o);if(a>6||o<u&&!V(c))return!1;if(r)return!0;u=e.skipSpacesBack(u,o);const s=e.skipCharsBack(u,35,o);s>o&&V(e.src.charCodeAt(s-1))&&(u=s),e.line=n+1;const d=e.push("heading_open","h"+String(a),1);d.markup="########".slice(0,a),d.map=[n,e.line];const p=e.push("inline","",0);p.content=xt(e.src.slice(o,u)),p.map=[n,e.line],p.children=[];const l=e.push("heading_close","h"+String(a),-1);return l.markup="########".slice(0,a),!0}function hc(e,n,t){const r=e.md.block.ruler.getRules("paragraph");if(e.sCount[n]-e.blkIndent>=4)return!1;const o=e.parentType;e.parentType="paragraph";let u=0,c,a=n+1;for(;a<t&&!e.isEmpty(a);a++){if(e.sCount[a]-e.blkIndent>3)continue;if(e.sCount[a]>=e.blkIndent){let h=e.bMarks[a]+e.tShift[a];const b=e.eMarks[a];if(h<b&&(c=e.src.charCodeAt(h),(c===45||c===61)&&(h=e.skipChars(h,c),h=e.skipSpaces(h),h>=b))){u=c===61?1:2;break}}if(e.sCount[a]<0)continue;let f=!1;for(let h=0,b=r.length;h<b;h++)if(r[h](e,a,t,!0)){f=!0;break}if(f)break}if(!u)return e.parentType=o,!1;const s=xt(e.getLines(n,a,e.blkIndent,!1));e.line=a+1;const d=e.push("heading_open","h"+String(u),1);d.markup=String.fromCharCode(c),d.map=[n,e.line];const p=e.push("inline","",0);p.content=s,p.map=[n,e.line-1],p.children=[];const l=e.push("heading_close","h"+String(u),-1);return l.markup=String.fromCharCode(c),e.parentType=o,!0}function pc(e,n,t){const r=e.md.block.ruler.getRules("paragraph"),o=e.parentType;let u=n+1;for(e.parentType="paragraph";u<t&&!e.isEmpty(u);u++){if(e.sCount[u]-e.blkIndent>3||e.sCount[u]<0)continue;let d=!1;for(let p=0,l=r.length;p<l;p++)if(r[p](e,u,t,!0)){d=!0;break}if(d)break}const c=xt(e.getLines(n,u,e.blkIndent,!1));e.line=u;const a=e.push("paragraph_open","p",1);a.map=[n,e.line];const s=e.push("inline","",0);return s.content=c,s.map=[n,e.line],s.children=[],e.push("paragraph_close","p",-1),e.parentType=o,!0}const rt=[["table",Ua,["paragraph","reference"]],["code",Ga],["fence",Va,["paragraph","reference","blockquote","list"]],["blockquote",Za,["paragraph","reference","blockquote","list"]],["hr",Wa,["paragraph","reference","blockquote","list"]],["list",Ya,["paragraph","reference","blockquote"]],["reference",Ja],["html_block",dc,["paragraph","reference","blockquote"]],["heading",fc,["paragraph","reference","blockquote"]],["lheading",hc],["paragraph",pc]];function vt(){this.ruler=new ie;for(let e=0;e<rt.length;e++)this.ruler.push(rt[e][0],rt[e][1],{alt:(rt[e][2]||[]).slice()})}vt.prototype.tokenize=function(e,n,t){const r=this.ruler.getRules(""),o=r.length,u=e.md.options.maxNesting;let c=n,a=!1;for(;c<t&&(e.line=c=e.skipEmptyLines(c),!(c>=t||e.sCount[c]<e.blkIndent));){if(e.level>=u){e.line=t;break}const s=e.line;let d=!1;for(let p=0;p<o;p++)if(d=r[p](e,c,t,!1),d){if(s>=e.line)throw new Error("block rule didn't increment state.line");break}if(!d)throw new Error("none of the block rules matched");e.tight=!a,e.isEmpty(e.line-1)&&(a=!0),c=e.line,c<t&&e.isEmpty(c)&&(a=!0,c++,e.line=c)}};vt.prototype.parse=function(e,n,t,r){if(!e)return;const o=new this.State(e,n,t,r);this.tokenize(o,o.line,o.lineMax)};vt.prototype.State=we;function Bn(e,n,t,r){this.src=e,this.env=t,this.md=n,this.tokens=r,this.tokens_meta=Array(r.length),this.pos=0,this.posMax=this.src.length,this.level=0,this.pending="",this.pendingLevel=0,this.cache={},this.delimiters=[],this._prev_delimiters=[],this.backticks={},this.backticksScanned=!1,this.linkLevel=0}Bn.prototype.pushPending=function(){const e=new ke("text","",0);return e.content=this.pending,e.level=this.pendingLevel,this.tokens.push(e),this.pending="",e};Bn.prototype.push=function(e,n,t){this.pending&&this.pushPending();const r=new ke(e,n,t);let o=null;return t<0&&(this.level--,this.delimiters=this._prev_delimiters.pop()),r.level=this.level,t>0&&(this.level++,this._prev_delimiters.push(this.delimiters),this.delimiters=[],o={delimiters:this.delimiters}),this.pendingLevel=this.level,this.tokens.push(r),this.tokens_meta.push(o),r};Bn.prototype.scanDelims=function(e,n){const t=this.posMax,r=this.src.charCodeAt(e);let o;if(e===0)o=32;else if(e===1)o=this.src.charCodeAt(0),(o&63488)===55296&&(o=65533);else if(o=this.src.charCodeAt(e-1),(o&64512)===56320){const k=this.src.charCodeAt(e-2);o=(k&64512)===55296?65536+(k-55296<<10)+(o-56320):65533}else(o&64512)===55296&&(o=65533);let u=e;for(;u<t&&this.src.charCodeAt(u)===r;)u++;const c=u-e;let a=u<t?this.src.charCodeAt(u):32;if((a&64512)===55296){const k=this.src.charCodeAt(u+1);a=(k&64512)===56320?65536+(a-55296<<10)+(k-56320):65533}else(a&64512)===56320&&(a=65533);const s=In(o)||Mn(o),d=In(a)||Mn(a),p=Fn(o),l=Fn(a),f=!l&&(!d||p||s),h=!p&&(!s||l||d);return{can_open:f&&(n||!h||s),can_close:h&&(n||!f||d),length:c}};Bn.prototype.Token=ke;function mc(e){switch(e){case 10:case 33:case 35:case 36:case 37:case 38:case 42:case 43:case 45:case 58:case 60:case 61:case 62:case 64:case 91:case 92:case 93:case 94:case 95:case 96:case 123:case 125:case 126:return!0;default:return!1}}function bc(e,n){let t=e.pos;for(;t<e.posMax&&!mc(e.src.charCodeAt(t));)t++;return t===e.pos?!1:(n||(e.pending+=e.src.slice(e.pos,t)),e.pos=t,!0)}const gc=/(?:^|[^a-z0-9.+-])([a-z][a-z0-9.+-]*)$/i;function kc(e,n){if(!e.md.options.linkify||e.linkLevel>0)return!1;const t=e.pos,r=e.posMax;if(t+3>r||e.src.charCodeAt(t)!==58||e.src.charCodeAt(t+1)!==47||e.src.charCodeAt(t+2)!==47)return!1;const o=e.pending.match(gc);if(!o)return!1;const u=o[1],c=e.md.linkify.matchAtStart(e.src.slice(t-u.length));if(!c)return!1;let a=c.url;if(a.length<=u.length)return!1;let s=a.length;for(;s>0&&a.charCodeAt(s-1)===42;)s--;s!==a.length&&(a=a.slice(0,s));const d=e.md.normalizeLink(a);if(!e.md.validateLink(d))return!1;if(!n){e.pending=e.pending.slice(0,-u.length);const p=e.push("link_open","a",1);p.attrs=[["href",d]],p.markup="linkify",p.info="auto";const l=e.push("text","",0);l.content=e.md.normalizeLinkText(a);const f=e.push("link_close","a",-1);f.markup="linkify",f.info="auto"}return e.pos+=a.length-u.length,!0}function yc(e,n){let t=e.pos;if(e.src.charCodeAt(t)!==10)return!1;const r=e.pending.length-1,o=e.posMax;if(!n)if(r>=0&&e.pending.charCodeAt(r)===32)if(r>=1&&e.pending.charCodeAt(r-1)===32){let u=r-1;for(;u>=1&&e.pending.charCodeAt(u-1)===32;)u--;e.pending=e.pending.slice(0,u),e.push("hardbreak","br",0)}else e.pending=e.pending.slice(0,-1),e.push("softbreak","br",0);else e.push("softbreak","br",0);for(t++;t<o&&V(e.src.charCodeAt(t));)t++;return e.pos=t,!0}const Er=[];for(let e=0;e<256;e++)Er.push(0);"\\!\"#$%&'()*+,./:;<=>?@[]^_`{|}~-".split("").forEach(function(e){Er[e.charCodeAt(0)]=1});function xc(e,n){let t=e.pos;const r=e.posMax;if(e.src.charCodeAt(t)!==92||(t++,t>=r))return!1;let o=e.src.charCodeAt(t);if(o===10){for(n||e.push("hardbreak","br",0),t++;t<r&&(o=e.src.charCodeAt(t),!!V(o));)t++;return e.pos=t,!0}let u=e.src[t];if(o>=55296&&o<=56319&&t+1<r){const a=e.src.charCodeAt(t+1);a>=56320&&a<=57343&&(u+=e.src[t+1],t++)}const c="\\"+u;if(!n){const a=e.push("text_special","",0);o<256&&Er[o]!==0?a.content=u:a.content=c,a.markup=c,a.info="escape"}return e.pos=t+1,!0}function vc(e,n){let t=e.pos;if(e.src.charCodeAt(t)!==96)return!1;const o=t;t++;const u=e.posMax;for(;t<u&&e.src.charCodeAt(t)===96;)t++;const c=e.src.slice(o,t),a=c.length;if(e.backticksScanned&&(e.backticks[a]||0)<=o)return n||(e.pending+=c),e.pos+=a,!0;let s=t,d;for(;(d=e.src.indexOf("`",s))!==-1;){for(s=d+1;s<u&&e.src.charCodeAt(s)===96;)s++;const p=s-d;if(p===a){if(!n){const l=e.push("code_inline","code",0);l.markup=c,l.content=e.src.slice(t,d).replace(/\n/g," ").replace(/^ (.+) $/,"$1")}return e.pos=s,!0}e.backticks[p]=d}return e.backticksScanned=!0,n||(e.pending+=c),e.pos+=a,!0}function wc(e,n){const t=e.pos,r=e.src.charCodeAt(t);if(n||r!==126)return!1;const o=e.scanDelims(e.pos,!0);let u=o.length;const c=String.fromCharCode(r);if(u<2)return!1;let a;u%2&&(a=e.push("text","",0),a.content=c,u--);for(let s=0;s<u;s+=2)a=e.push("text","",0),a.content=c+c,e.delimiters.push({marker:r,length:0,token:e.tokens.length-1,end:-1,open:o.can_open,close:o.can_close});return e.pos+=o.length,!0}function lo(e,n){let t;const r=[],o=n.length;for(let u=0;u<o;u++){const c=n[u];if(c.marker!==126||c.end===-1)continue;const a=n[c.end];t=e.tokens[c.token],t.type="s_open",t.tag="s",t.nesting=1,t.markup="~~",t.content="",t=e.tokens[a.token],t.type="s_close",t.tag="s",t.nesting=-1,t.markup="~~",t.content="",e.tokens[a.token-1].type==="text"&&e.tokens[a.token-1].content==="~"&&r.push(a.token-1)}for(;r.length;){const u=r.pop();let c=u+1;for(;c<e.tokens.length&&e.tokens[c].type==="s_close";)c++;c--,u!==c&&(t=e.tokens[c],e.tokens[c]=e.tokens[u],e.tokens[u]=t)}}function Cc(e){const n=e.tokens_meta,t=e.tokens_meta.length;lo(e,e.delimiters);for(let r=0;r<t;r++)n[r]&&n[r].delimiters&&lo(e,n[r].delimiters)}const Jo={tokenize:wc,postProcess:Cc};function _c(e,n){const t=e.pos,r=e.src.charCodeAt(t);if(n||r!==95&&r!==42)return!1;const o=e.scanDelims(e.pos,r===42);for(let u=0;u<o.length;u++){const c=e.push("text","",0);c.content=String.fromCharCode(r),e.delimiters.push({marker:r,length:o.length,token:e.tokens.length-1,end:-1,open:o.can_open,close:o.can_close})}return e.pos+=o.length,!0}function so(e,n){const t=n.length;for(let r=t-1;r>=0;r--){const o=n[r];if(o.marker!==95&&o.marker!==42||o.end===-1)continue;const u=n[o.end],c=r>0&&n[r-1].end===o.end+1&&n[r-1].marker===o.marker&&n[r-1].token===o.token-1&&n[o.end+1].token===u.token+1,a=String.fromCharCode(o.marker),s=e.tokens[o.token];s.type=c?"strong_open":"em_open",s.tag=c?"strong":"em",s.nesting=1,s.markup=c?a+a:a,s.content="";const d=e.tokens[u.token];d.type=c?"strong_close":"em_close",d.tag=c?"strong":"em",d.nesting=-1,d.markup=c?a+a:a,d.content="",c&&(e.tokens[n[r-1].token].content="",e.tokens[n[o.end+1].token].content="",r--)}}function Ec(e){const n=e.tokens_meta,t=e.tokens_meta.length;so(e,e.delimiters);for(let r=0;r<t;r++)n[r]&&n[r].delimiters&&so(e,n[r].delimiters)}const Qo={tokenize:_c,postProcess:Ec};function Ac(e,n){let t,r,o,u,c="",a="",s=e.pos,d=!0;if(e.src.charCodeAt(e.pos)!==91)return!1;const p=e.pos,l=e.posMax,f=e.pos+1,h=e.md.helpers.parseLinkLabel(e,e.pos,!0);if(h<0)return!1;let b=h+1;if(b<l&&e.src.charCodeAt(b)===40){for(d=!1,b++;b<l&&(t=e.src.charCodeAt(b),!(!V(t)&&t!==10));b++);if(b>=l)return!1;if(s=b,o=e.md.helpers.parseLinkDestination(e.src,b,e.posMax),o.ok){for(c=e.md.normalizeLink(o.str),e.md.validateLink(c)?b=o.pos:c="",s=b;b<l&&(t=e.src.charCodeAt(b),!(!V(t)&&t!==10));b++);if(o=e.md.helpers.parseLinkTitle(e.src,b,e.posMax),b<l&&s!==b&&o.ok)for(a=o.str,b=o.pos;b<l&&(t=e.src.charCodeAt(b),!(!V(t)&&t!==10));b++);}(b>=l||e.src.charCodeAt(b)!==41)&&(d=!0),b++}if(d){if(typeof e.env.references>"u")return!1;if(b<l&&e.src.charCodeAt(b)===91?(s=b+1,b=e.md.helpers.parseLinkLabel(e,b),b>=0?r=e.src.slice(s,b++):b=h+1):b=h+1,r||(r=e.src.slice(f,h)),u=e.env.references[yt(r)],!u)return e.pos=p,!1;c=u.href,a=u.title}if(!n){e.pos=f,e.posMax=h;const g=e.push("link_open","a",1),k=[["href",c]];g.attrs=k,a&&k.push(["title",a]),e.linkLevel++,e.md.inline.tokenize(e),e.linkLevel--,e.push("link_close","a",-1)}return e.pos=b,e.posMax=l,!0}function Sc(e,n){let t,r,o,u,c,a,s,d,p="";const l=e.pos,f=e.posMax;if(e.src.charCodeAt(e.pos)!==33||e.src.charCodeAt(e.pos+1)!==91)return!1;const h=e.pos+2,b=e.md.helpers.parseLinkLabel(e,e.pos+1,!1);if(b<0)return!1;if(u=b+1,u<f&&e.src.charCodeAt(u)===40){for(u++;u<f&&(t=e.src.charCodeAt(u),!(!V(t)&&t!==10));u++);if(u>=f)return!1;for(d=u,a=e.md.helpers.parseLinkDestination(e.src,u,e.posMax),a.ok&&(p=e.md.normalizeLink(a.str),e.md.validateLink(p)?u=a.pos:p=""),d=u;u<f&&(t=e.src.charCodeAt(u),!(!V(t)&&t!==10));u++);if(a=e.md.helpers.parseLinkTitle(e.src,u,e.posMax),u<f&&d!==u&&a.ok)for(s=a.str,u=a.pos;u<f&&(t=e.src.charCodeAt(u),!(!V(t)&&t!==10));u++);else s="";if(u>=f||e.src.charCodeAt(u)!==41)return e.pos=l,!1;u++}else{if(typeof e.env.references>"u")return!1;if(u<f&&e.src.charCodeAt(u)===91?(d=u+1,u=e.md.helpers.parseLinkLabel(e,u),u>=0?o=e.src.slice(d,u++):u=b+1):u=b+1,o||(o=e.src.slice(h,b)),c=e.env.references[yt(o)],!c)return e.pos=l,!1;p=c.href,s=c.title}if(!n){r=e.src.slice(h,b);const g=[];e.md.inline.parse(r,e.md,e.env,g);const k=e.push("image","img",0),y=[["src",p],["alt",""]];k.attrs=y,k.children=g,k.content=r,s&&y.push(["title",s])}return e.pos=u,e.posMax=f,!0}const Dc=/^([a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)$/,Tc=/^([a-zA-Z][a-zA-Z0-9+.-]{1,31}):([^<>\x00-\x20]*)$/;function Fc(e,n){let t=e.pos;if(e.src.charCodeAt(t)!==60)return!1;const r=e.pos,o=e.posMax;for(;;){if(++t>=o)return!1;const c=e.src.charCodeAt(t);if(c===60)return!1;if(c===62)break}const u=e.src.slice(r+1,t);if(Tc.test(u)){const c=e.md.normalizeLink(u);if(!e.md.validateLink(c))return!1;if(!n){const a=e.push("link_open","a",1);a.attrs=[["href",c]],a.markup="autolink",a.info="auto";const s=e.push("text","",0);s.content=e.md.normalizeLinkText(u);const d=e.push("link_close","a",-1);d.markup="autolink",d.info="auto"}return e.pos+=u.length+2,!0}if(Dc.test(u)){const c=e.md.normalizeLink("mailto:"+u);if(!e.md.validateLink(c))return!1;if(!n){const a=e.push("link_open","a",1);a.attrs=[["href",c]],a.markup="autolink",a.info="auto";const s=e.push("text","",0);s.content=e.md.normalizeLinkText(u);const d=e.push("link_close","a",-1);d.markup="autolink",d.info="auto"}return e.pos+=u.length+2,!0}return!1}function Mc(e){return/^<a[>\s]/i.test(e)}function Ic(e){return/^<\/a\s*>/i.test(e)}function Rc(e){const n=e|32;return n>=97&&n<=122}function Lc(e,n){if(!e.md.options.html)return!1;const t=e.posMax,r=e.pos;if(e.src.charCodeAt(r)!==60||r+2>=t)return!1;const o=e.src.charCodeAt(r+1);if(o!==33&&o!==63&&o!==47&&!Rc(o))return!1;const u=e.src.slice(r).match(lc);if(!u)return!1;if(!n){const c=e.push("html_inline","",0);c.content=u[0],Mc(c.content)&&e.linkLevel++,Ic(c.content)&&e.linkLevel--}return e.pos+=u[0].length,!0}const Nc=/^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i,Oc=/^&([a-z][a-z0-9]{1,31});/i;function Pc(e,n){const t=e.pos,r=e.posMax;if(e.src.charCodeAt(t)!==38||t+1>=r)return!1;if(e.src.charCodeAt(t+1)===35){const u=e.src.slice(t).match(Nc);if(u){if(!n){const c=u[1][0].toLowerCase()==="x"?parseInt(u[1].slice(1),16):parseInt(u[1],10),a=e.push("text_special","",0);a.content=Cr(c)?Tn(c):Tn(65533),a.markup=u[0],a.info="entity"}return e.pos+=u[0].length,!0}}else{const u=e.src.slice(t).match(Oc);if(u){const c=ta(u[0]);if(c!==u[0]){if(!n){const a=e.push("text_special","",0);a.content=c,a.markup=u[0],a.info="entity"}return e.pos+=u[0].length,!0}}}return!1}function fo(e){const n={},t=e.length;if(!t)return;let r=0,o=-2;const u=[];for(let c=0;c<t;c++){const a=e[c];if(u.push(0),(e[r].marker!==a.marker||o!==a.token-1)&&(r=c),o=a.token,a.length=a.length||0,!a.close)continue;n.hasOwnProperty(a.marker)||(n[a.marker]=[-1,-1,-1,-1,-1,-1]);const s=n[a.marker][(a.open?3:0)+a.length%3];let d=r-u[r]-1,p=d;for(;d>s;d-=u[d]+1){const l=e[d];if(l.marker===a.marker&&l.open&&l.end<0){let f=!1;if((l.close||a.open)&&(l.length+a.length)%3===0&&(l.length%3!==0||a.length%3!==0)&&(f=!0),!f){const h=d>0&&!e[d-1].open?u[d-1]+1:0;u[c]=c-d+h,u[d]=h,a.open=!1,l.end=c,l.close=!1,p=-1,o=-2;break}}}p!==-1&&(n[a.marker][(a.open?3:0)+(a.length||0)%3]=p)}}function Bc(e){const n=e.tokens_meta,t=e.tokens_meta.length;fo(e.delimiters);for(let r=0;r<t;r++)n[r]&&n[r].delimiters&&fo(n[r].delimiters)}function zc(e){let n,t,r=0;const o=e.tokens,u=e.tokens.length;for(n=t=0;n<u;n++)o[n].nesting<0&&r--,o[n].level=r,o[n].nesting>0&&r++,o[n].type==="text"&&n+1<u&&o[n+1].type==="text"?o[n+1].content=o[n].content+o[n+1].content:(n!==t&&(o[t]=o[n]),t++);n!==t&&(o.length=t)}const qt=[["text",bc],["linkify",kc],["newline",yc],["escape",xc],["backticks",vc],["strikethrough",Jo.tokenize],["emphasis",Qo.tokenize],["link",Ac],["image",Sc],["autolink",Fc],["html_inline",Lc],["entity",Pc]],Ht=[["balance_pairs",Bc],["strikethrough",Jo.postProcess],["emphasis",Qo.postProcess],["fragments_join",zc]];function zn(){this.ruler=new ie;for(let e=0;e<qt.length;e++)this.ruler.push(qt[e][0],qt[e][1]);this.ruler2=new ie;for(let e=0;e<Ht.length;e++)this.ruler2.push(Ht[e][0],Ht[e][1])}zn.prototype.skipToken=function(e){const n=e.pos,t=this.ruler.getRules(""),r=t.length,o=e.md.options.maxNesting,u=e.cache;if(typeof u[n]<"u"){e.pos=u[n];return}let c=!1;if(e.level<o){for(let a=0;a<r;a++)if(e.level++,c=t[a](e,!0),e.level--,c){if(n>=e.pos)throw new Error("inline rule didn't increment state.pos");break}}else e.pos=e.posMax;c||e.pos++,u[n]=e.pos};zn.prototype.tokenize=function(e){const n=this.ruler.getRules(""),t=n.length,r=e.posMax,o=e.md.options.maxNesting;for(;e.pos<r;){const u=e.pos;let c=!1;if(e.level<o){for(let a=0;a<t;a++)if(c=n[a](e,!1),c){if(u>=e.pos)throw new Error("inline rule didn't increment state.pos");break}}if(c){if(e.pos>=r)break;continue}e.pending+=e.src[e.pos++]}e.pending&&e.pushPending()};zn.prototype.parse=function(e,n,t,r){const o=new this.State(e,n,t,r);this.tokenize(o);const u=this.ruler2.getRules(""),c=u.length;for(let a=0;a<c;a++)u[a](o)};zn.prototype.State=Bn;function qc(e){const n={};e=e||{},n.src_Any=Bo.source,n.src_Cc=zo.source,n.src_Z=Ho.source,n.src_P=vr.source,n.src_ZPCc=[n.src_Z,n.src_P,n.src_Cc].join("|"),n.src_ZCc=[n.src_Z,n.src_Cc].join("|");const t="[><｜]";return n.src_pseudo_letter="(?:(?!"+t+"|"+n.src_ZPCc+")"+n.src_Any+")",n.src_ip4="(?:(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)",n.src_auth="(?:(?:(?!"+n.src_ZCc+"|[@/\\[\\]()]).)+@)?",n.src_port="(?::(?:6(?:[0-4]\\d{3}|5(?:[0-4]\\d{2}|5(?:[0-2]\\d|3[0-5])))|[1-5]?\\d{1,4}))?",n.src_host_terminator="(?=$|"+t+"|"+n.src_ZPCc+")(?!"+(e["---"]?"-(?!--)|":"-|")+"_|:\\d|\\.-|\\.(?!$|"+n.src_ZPCc+"))",n.src_path="(?:[/?#](?:(?!"+n.src_ZCc+"|"+t+`|[()[\\]{}.,"'?!\\-;]).|\\[(?:(?!`+n.src_ZCc+"|\\]).)*\\]|\\((?:(?!"+n.src_ZCc+"|[)]).)*\\)|\\{(?:(?!"+n.src_ZCc+'|[}]).)*\\}|\\"(?:(?!'+n.src_ZCc+`|["]).)+\\"|\\'(?:(?!`+n.src_ZCc+"|[']).)+\\'|\\'(?="+n.src_pseudo_letter+"|[-])|\\.{2,}[a-zA-Z0-9%/&]|\\.(?!"+n.src_ZCc+"|[.]|$)|"+(e["---"]?"\\-(?!--(?:[^-]|$))(?:-*)|":"\\-+|")+",(?!"+n.src_ZCc+"|$)|;(?!"+n.src_ZCc+"|$)|\\!+(?!"+n.src_ZCc+"|[!]|$)|\\?(?!"+n.src_ZCc+"|[?]|$))+|\\/)?",n.src_email_name='[\\-;:&=\\+\\$,\\.a-zA-Z0-9_][\\-;:&=\\+\\$,\\"\\.a-zA-Z0-9_]*',n.src_xn="xn--[a-z0-9\\-]{1,59}",n.src_domain_root="(?:"+n.src_xn+"|"+n.src_pseudo_letter+"{1,63})",n.src_domain="(?:"+n.src_xn+"|(?:"+n.src_pseudo_letter+")|(?:"+n.src_pseudo_letter+"(?:-|"+n.src_pseudo_letter+"){0,61}"+n.src_pseudo_letter+"))",n.src_host="(?:(?:(?:(?:"+n.src_domain+")\\.)*"+n.src_domain+"))",n.tpl_host_fuzzy="(?:"+n.src_ip4+"|(?:(?:(?:"+n.src_domain+")\\.)+(?:%TLDS%)))",n.tpl_host_no_ip_fuzzy="(?:(?:(?:"+n.src_domain+")\\.)+(?:%TLDS%))",n.src_host_strict=n.src_host+n.src_host_terminator,n.tpl_host_fuzzy_strict=n.tpl_host_fuzzy+n.src_host_terminator,n.src_host_port_strict=n.src_host+n.src_port+n.src_host_terminator,n.tpl_host_port_fuzzy_strict=n.tpl_host_fuzzy+n.src_port+n.src_host_terminator,n.tpl_host_port_no_ip_fuzzy_strict=n.tpl_host_no_ip_fuzzy+n.src_port+n.src_host_terminator,n.tpl_host_fuzzy_test="localhost|www\\.|\\.\\d{1,3}\\.|(?:\\.(?:%TLDS%)(?:"+n.src_ZPCc+"|>|$))",n.tpl_email_fuzzy="(^|"+t+'|"|\\(|'+n.src_ZCc+")("+n.src_email_name+"@"+n.tpl_host_fuzzy_strict+")",n.tpl_link_fuzzy="(^|(?![.:/\\-_@])(?:[$+<=>^`|｜]|"+n.src_ZPCc+"))((?![$+<=>^`|｜])"+n.tpl_host_port_fuzzy_strict+n.src_path+")",n.tpl_link_no_ip_fuzzy="(^|(?![.:/\\-_@])(?:[$+<=>^`|｜]|"+n.src_ZPCc+"))((?![$+<=>^`|｜])"+n.tpl_host_port_no_ip_fuzzy_strict+n.src_path+")",n}function or(e){return Array.prototype.slice.call(arguments,1).forEach(function(t){t&&Object.keys(t).forEach(function(r){e[r]=t[r]})}),e}function wt(e){return Object.prototype.toString.call(e)}function Hc(e){return wt(e)==="[object String]"}function jc(e){return wt(e)==="[object Object]"}function $c(e){return wt(e)==="[object RegExp]"}function ho(e){return wt(e)==="[object Function]"}function Uc(e){return e.replace(/[.?*+^$[\]\\(){}|-]/g,"\\$&")}const Xo={fuzzyLink:!0,fuzzyEmail:!0,fuzzyIP:!1};function Gc(e){return Object.keys(e||{}).reduce(function(n,t){return n||Xo.hasOwnProperty(t)},!1)}const Vc={"http:":{validate:function(e,n,t){const r=e.slice(n);return t.re.http||(t.re.http=new RegExp("^\\/\\/"+t.re.src_auth+t.re.src_host_port_strict+t.re.src_path,"i")),t.re.http.test(r)?r.match(t.re.http)[0].length:0}},"https:":"http:","ftp:":"http:","//":{validate:function(e,n,t){const r=e.slice(n);return t.re.no_http||(t.re.no_http=new RegExp("^"+t.re.src_auth+"(?:localhost|(?:(?:"+t.re.src_domain+")\\.)+"+t.re.src_domain_root+")"+t.re.src_port+t.re.src_host_terminator+t.re.src_path,"i")),t.re.no_http.test(r)?n>=3&&e[n-3]===":"||n>=3&&e[n-3]==="/"?0:r.match(t.re.no_http)[0].length:0}},"mailto:":{validate:function(e,n,t){const r=e.slice(n);return t.re.mailto||(t.re.mailto=new RegExp("^"+t.re.src_email_name+"@"+t.re.src_host_strict,"i")),t.re.mailto.test(r)?r.match(t.re.mailto)[0].length:0}}},Zc="a[cdefgilmnoqrstuwxz]|b[abdefghijmnorstvwyz]|c[acdfghiklmnoruvwxyz]|d[ejkmoz]|e[cegrstu]|f[ijkmor]|g[abdefghilmnpqrstuwy]|h[kmnrtu]|i[delmnoqrst]|j[emop]|k[eghimnprwyz]|l[abcikrstuvy]|m[acdeghklmnopqrstuvwxyz]|n[acefgilopruz]|om|p[aefghklmnrstwy]|qa|r[eosuw]|s[abcdeghijklmnortuvxyz]|t[cdfghjklmnortvwz]|u[agksyz]|v[aceginu]|w[fs]|y[et]|z[amw]",Wc="biz|com|edu|gov|net|org|pro|web|xxx|aero|asia|coop|info|museum|name|shop|рф".split("|");function Kc(e){return function(n,t){const r=n.slice(t);return e.test(r)?r.match(e)[0].length:0}}function po(){return function(e,n){n.normalize(e)}}function st(e){const n=e.re=qc(e.__opts__),t=e.__tlds__.slice();e.onCompile(),e.__tlds_replaced__||t.push(Zc),t.push(n.src_xn),n.src_tlds=t.join("|");function r(a){return a.replace("%TLDS%",n.src_tlds)}n.email_fuzzy=RegExp(r(n.tpl_email_fuzzy),"i"),n.email_fuzzy_global=RegExp(r(n.tpl_email_fuzzy),"ig"),n.link_fuzzy=RegExp(r(n.tpl_link_fuzzy),"i"),n.link_fuzzy_global=RegExp(r(n.tpl_link_fuzzy),"ig"),n.link_no_ip_fuzzy=RegExp(r(n.tpl_link_no_ip_fuzzy),"i"),n.link_no_ip_fuzzy_global=RegExp(r(n.tpl_link_no_ip_fuzzy),"ig"),n.host_fuzzy_test=RegExp(r(n.tpl_host_fuzzy_test),"i");const o=[];e.__compiled__={};function u(a,s){throw new Error('(LinkifyIt) Invalid schema "'+a+'": '+s)}Object.keys(e.__schemas__).forEach(function(a){const s=e.__schemas__[a];if(s===null)return;const d={validate:null,link:null};if(e.__compiled__[a]=d,jc(s)){$c(s.validate)?d.validate=Kc(s.validate):ho(s.validate)?d.validate=s.validate:u(a,s),ho(s.normalize)?d.normalize=s.normalize:s.normalize?u(a,s):d.normalize=po();return}if(Hc(s)){o.push(a);return}u(a,s)}),o.forEach(function(a){e.__compiled__[e.__schemas__[a]]&&(e.__compiled__[a].validate=e.__compiled__[e.__schemas__[a]].validate,e.__compiled__[a].normalize=e.__compiled__[e.__schemas__[a]].normalize)}),e.__compiled__[""]={validate:null,normalize:po()};const c=Object.keys(e.__compiled__).filter(function(a){return a.length>0&&e.__compiled__[a]}).map(Uc).join("|");e.re.schema_test=RegExp("(^|(?!_)(?:[><｜]|"+n.src_ZPCc+"))("+c+")","i"),e.re.schema_search=RegExp("(^|(?!_)(?:[><｜]|"+n.src_ZPCc+"))("+c+")","ig"),e.re.schema_at_start=RegExp("^"+e.re.schema_search.source,"i"),e.re.pretest=RegExp("("+e.re.schema_test.source+")|("+e.re.host_fuzzy_test.source+")|@","i")}function eu(e,n,t,r){const o=e.slice(t,r);this.schema=n.toLowerCase(),this.index=t,this.lastIndex=r,this.raw=o,this.text=o,this.url=o}function ce(e,n){if(!(this instanceof ce))return new ce(e,n);n||Gc(e)&&(n=e,e={}),this.__opts__=or({},Xo,n),this.__schemas__=or({},Vc,e),this.__compiled__={},this.__tlds__=Wc,this.__tlds_replaced__=!1,this.re={},st(this)}ce.prototype.add=function(n,t){return this.__schemas__[n]=t,st(this),this};ce.prototype.set=function(n){return this.__opts__=or(this.__opts__,n),this};ce.prototype.test=function(n){if(!n.length)return!1;let t,r;if(this.re.schema_test.test(n)){for(r=this.re.schema_search,r.lastIndex=0;(t=r.exec(n))!==null;)if(this.testSchemaAt(n,t[2],r.lastIndex))return!0}return!!(this.__opts__.fuzzyLink&&this.__compiled__["http:"]&&n.search(this.re.host_fuzzy_test)>=0&&n.match(this.__opts__.fuzzyIP?this.re.link_fuzzy:this.re.link_no_ip_fuzzy)!==null||this.__opts__.fuzzyEmail&&this.__compiled__["mailto:"]&&n.indexOf("@")>=0&&n.match(this.re.email_fuzzy)!==null)};ce.prototype.pretest=function(n){return this.re.pretest.test(n)};ce.prototype.testSchemaAt=function(n,t,r){return this.__compiled__[t.toLowerCase()]?this.__compiled__[t.toLowerCase()].validate(n,r,this):0};ce.prototype.match=function(n){const t=[],r=[],o=[],u=[];let c,a,s;function d(f,h){return f?h?f.index!==h.index?f.index<h.index?f:h:f.lastIndex>=h.lastIndex?f:h:f:h}if(!n.length)return null;if(this.re.schema_test.test(n))for(s=this.re.schema_search,s.lastIndex=0;(c=s.exec(n))!==null;)a=this.testSchemaAt(n,c[2],s.lastIndex),a&&r.push({schema:c[2],index:c.index+c[1].length,lastIndex:c.index+c[0].length+a});if(this.__opts__.fuzzyLink&&this.__compiled__["http:"])for(s=this.__opts__.fuzzyIP?this.re.link_fuzzy_global:this.re.link_no_ip_fuzzy_global,s.lastIndex=0;(c=s.exec(n))!==null;)o.push({schema:"",index:c.index+c[1].length,lastIndex:c.index+c[0].length});if(this.__opts__.fuzzyEmail&&this.__compiled__["mailto:"])for(s=this.re.email_fuzzy_global,s.lastIndex=0;(c=s.exec(n))!==null;)u.push({schema:"mailto:",index:c.index+c[1].length,lastIndex:c.index+c[0].length});const p=[0,0,0];let l=0;for(;;){const f=[r[p[0]],u[p[1]],o[p[2]]],h=d(d(f[0],f[1]),f[2]);if(!h)break;if(h===f[0]?p[0]++:h===f[1]?p[1]++:p[2]++,h.index<l)continue;const b=new eu(n,h.schema,h.index,h.lastIndex);this.__compiled__[b.schema].normalize(b,this),t.push(b),l=h.lastIndex}return t.length?t:null};ce.prototype.matchAtStart=function(n){if(!n.length)return null;const t=this.re.schema_at_start.exec(n);if(!t)return null;const r=this.testSchemaAt(n,t[2],t[0].length);if(!r)return null;const o=new eu(n,t[2],t.index+t[1].length,t.index+t[0].length+r);return this.__compiled__[o.schema].normalize(o,this),o};ce.prototype.tlds=function(n,t){return n=Array.isArray(n)?n:[n],t?(this.__tlds__=this.__tlds__.concat(n).sort().filter(function(r,o,u){return r!==u[o-1]}).reverse(),st(this),this):(this.__tlds__=n.slice(),this.__tlds_replaced__=!0,st(this),this)};ce.prototype.normalize=function(n){n.schema||(n.url="http://"+n.url),n.schema==="mailto:"&&!/^mailto:/i.test(n.url)&&(n.url="mailto:"+n.url)};ce.prototype.onCompile=function(){};const cn=2147483647,ye=36,Ar=1,Rn=26,Yc=38,Jc=700,nu=72,tu=128,ru="-",Qc=/^xn--/,Xc=/[^\0-\x7F]/,el=/[\x2E\u3002\uFF0E\uFF61]/g,nl={overflow:"Overflow: input needs wider integers to process","not-basic":"Illegal input >= 0x80 (not a basic code point)","invalid-input":"Invalid input"},jt=ye-Ar,xe=Math.floor,$t=String.fromCharCode;function Re(e){throw new RangeError(nl[e])}function tl(e,n){const t=[];let r=e.length;for(;r--;)t[r]=n(e[r]);return t}function ou(e,n){const t=e.split("@");let r="";t.length>1&&(r=t[0]+"@",e=t[1]),e=e.replace(el,".");const o=e.split("."),u=tl(o,n).join(".");return r+u}function uu(e){const n=[];let t=0;const r=e.length;for(;t<r;){const o=e.charCodeAt(t++);if(o>=55296&&o<=56319&&t<r){const u=e.charCodeAt(t++);(u&64512)==56320?n.push(((o&1023)<<10)+(u&1023)+65536):(n.push(o),t--)}else n.push(o)}return n}const rl=e=>String.fromCodePoint(...e),ol=function(e){return e>=48&&e<58?26+(e-48):e>=65&&e<91?e-65:e>=97&&e<123?e-97:ye},mo=function(e,n){return e+22+75*(e<26)-((n!=0)<<5)},iu=function(e,n,t){let r=0;for(e=t?xe(e/Jc):e>>1,e+=xe(e/n);e>jt*Rn>>1;r+=ye)e=xe(e/jt);return xe(r+(jt+1)*e/(e+Yc))},au=function(e){const n=[],t=e.length;let r=0,o=tu,u=nu,c=e.lastIndexOf(ru);c<0&&(c=0);for(let a=0;a<c;++a)e.charCodeAt(a)>=128&&Re("not-basic"),n.push(e.charCodeAt(a));for(let a=c>0?c+1:0;a<t;){const s=r;for(let p=1,l=ye;;l+=ye){a>=t&&Re("invalid-input");const f=ol(e.charCodeAt(a++));f>=ye&&Re("invalid-input"),f>xe((cn-r)/p)&&Re("overflow"),r+=f*p;const h=l<=u?Ar:l>=u+Rn?Rn:l-u;if(f<h)break;const b=ye-h;p>xe(cn/b)&&Re("overflow"),p*=b}const d=n.length+1;u=iu(r-s,d,s==0),xe(r/d)>cn-o&&Re("overflow"),o+=xe(r/d),r%=d,n.splice(r++,0,o)}return String.fromCodePoint(...n)},cu=function(e){const n=[];e=uu(e);const t=e.length;let r=tu,o=0,u=nu;for(const s of e)s<128&&n.push($t(s));const c=n.length;let a=c;for(c&&n.push(ru);a<t;){let s=cn;for(const p of e)p>=r&&p<s&&(s=p);const d=a+1;s-r>xe((cn-o)/d)&&Re("overflow"),o+=(s-r)*d,r=s;for(const p of e)if(p<r&&++o>cn&&Re("overflow"),p===r){let l=o;for(let f=ye;;f+=ye){const h=f<=u?Ar:f>=u+Rn?Rn:f-u;if(l<h)break;const b=l-h,g=ye-h;n.push($t(mo(h+b%g,0))),l=xe(b/g)}n.push($t(mo(l,0))),u=iu(o,d,a===c),o=0,++a}++o,++r}return n.join("")},ul=function(e){return ou(e,function(n){return Qc.test(n)?au(n.slice(4).toLowerCase()):n})},il=function(e){return ou(e,function(n){return Xc.test(n)?"xn--"+cu(n):n})},lu={version:"2.3.1",ucs2:{decode:uu,encode:rl},decode:au,encode:cu,toASCII:il,toUnicode:ul},al={options:{html:!1,xhtmlOut:!1,breaks:!1,langPrefix:"language-",linkify:!1,typographer:!1,quotes:"“”‘’",highlight:null,maxNesting:100},components:{core:{},block:{},inline:{}}},cl={options:{html:!1,xhtmlOut:!1,breaks:!1,langPrefix:"language-",linkify:!1,typographer:!1,quotes:"“”‘’",highlight:null,maxNesting:20},components:{core:{rules:["normalize","block","inline","text_join"]},block:{rules:["paragraph"]},inline:{rules:["text"],rules2:["balance_pairs","fragments_join"]}}},ll={options:{html:!0,xhtmlOut:!0,breaks:!1,langPrefix:"language-",linkify:!1,typographer:!1,quotes:"“”‘’",highlight:null,maxNesting:20},components:{core:{rules:["normalize","block","inline","text_join"]},block:{rules:["blockquote","code","fence","heading","hr","html_block","lheading","list","reference","paragraph"]},inline:{rules:["autolink","backticks","emphasis","entity","escape","html_inline","image","link","newline","text"],rules2:["balance_pairs","emphasis","fragments_join"]}}},sl={default:al,zero:cl,commonmark:ll},dl=/^(vbscript|javascript|file|data):/,fl=/^data:image\/(gif|png|jpeg|webp);/;function hl(e){const n=e.trim().toLowerCase();return dl.test(n)?fl.test(n):!0}const su=["http:","https:","mailto:"];function pl(e){const n=xr(e,!0);if(n.hostname&&(!n.protocol||su.indexOf(n.protocol)>=0))try{n.hostname=lu.toASCII(n.hostname)}catch{}return Pn(yr(n))}function ml(e){const n=xr(e,!0);if(n.hostname&&(!n.protocol||su.indexOf(n.protocol)>=0))try{n.hostname=lu.toUnicode(n.hostname)}catch{}return sn(yr(n),sn.defaultChars+"%")}function pe(e,n){if(!(this instanceof pe))return new pe(e,n);n||wr(e)||(n=e||{},e="default"),this.inline=new zn,this.block=new vt,this.core=new _r,this.renderer=new bn,this.linkify=new ce,this.validateLink=hl,this.normalizeLink=pl,this.normalizeLinkText=ml,this.utils=ka,this.helpers=kt({},wa),this.options={},this.configure(e),n&&this.set(n)}pe.prototype.set=function(e){return kt(this.options,e),this};pe.prototype.configure=function(e){const n=this;if(wr(e)){const t=e;if(e=sl[t],!e)throw new Error('Wrong `markdown-it` preset "'+t+'", check name')}if(!e)throw new Error("Wrong `markdown-it` preset, can't be empty");return e.options&&n.set(e.options),e.components&&Object.keys(e.components).forEach(function(t){e.components[t].rules&&n[t].ruler.enableOnly(e.components[t].rules),e.components[t].rules2&&n[t].ruler2.enableOnly(e.components[t].rules2)}),this};pe.prototype.enable=function(e,n){let t=[];Array.isArray(e)||(e=[e]),["core","block","inline"].forEach(function(o){t=t.concat(this[o].ruler.enable(e,!0))},this),t=t.concat(this.inline.ruler2.enable(e,!0));const r=e.filter(function(o){return t.indexOf(o)<0});if(r.length&&!n)throw new Error("MarkdownIt. Failed to enable unknown rule(s): "+r);return this};pe.prototype.disable=function(e,n){let t=[];Array.isArray(e)||(e=[e]),["core","block","inline"].forEach(function(o){t=t.concat(this[o].ruler.disable(e,!0))},this),t=t.concat(this.inline.ruler2.disable(e,!0));const r=e.filter(function(o){return t.indexOf(o)<0});if(r.length&&!n)throw new Error("MarkdownIt. Failed to disable unknown rule(s): "+r);return this};pe.prototype.use=function(e){const n=[this].concat(Array.prototype.slice.call(arguments,1));return e.apply(e,n),this};pe.prototype.parse=function(e,n){if(typeof e!="string")throw new Error("Input data should be a String");const t=new this.core.State(e,this,n);return this.core.process(t),t.tokens};pe.prototype.render=function(e,n){return n=n||{},this.renderer.render(this.parse(e,n),this.options,n)};pe.prototype.parseInline=function(e,n){const t=new this.core.State(e,this,n);return t.inlineMode=!0,this.core.process(t),t.tokens};pe.prototype.renderInline=function(e,n){return n=n||{},this.renderer.render(this.parseInline(e,n),this.options,n)};var bo=!1,fn={false:"push",true:"unshift",after:"push",before:"unshift"},dt={isPermalinkSymbol:!0};function ur(e,n,t,r){var o;if(!bo){var u="Using deprecated markdown-it-anchor permalink option, see https://github.com/valeriangalliat/markdown-it-anchor#permalinks";typeof process=="object"&&process&&process.emitWarning?process.emitWarning(u):console.warn(u),bo=!0}var c=[Object.assign(new t.Token("link_open","a",1),{attrs:[].concat(n.permalinkClass?[["class",n.permalinkClass]]:[],[["href",n.permalinkHref(e,t)]],Object.entries(n.permalinkAttrs(e,t)))}),Object.assign(new t.Token("html_block","",0),{content:n.permalinkSymbol,meta:dt}),new t.Token("link_close","a",-1)];n.permalinkSpace&&t.tokens[r+1].children[fn[n.permalinkBefore]](Object.assign(new t.Token("text","",0),{content:" "})),(o=t.tokens[r+1].children)[fn[n.permalinkBefore]].apply(o,c)}function du(e){return"#"+e}function fu(e){return{}}var bl={class:"header-anchor",symbol:"#",renderHref:du,renderAttrs:fu};function qn(e){function n(t){return t=Object.assign({},n.defaults,t),function(r,o,u,c){return e(r,t,o,u,c)}}return n.defaults=Object.assign({},bl),n.renderPermalinkImpl=e,n}function Sr(e){var n=[],t=e.filter(function(r){if(r[0]!=="class")return!0;n.push(r[1])});return n.length>0&&t.unshift(["class",n.join(" ")]),t}var Ct=qn(function(e,n,t,r,o){var u,c=[Object.assign(new r.Token("link_open","a",1),{attrs:Sr([].concat(n.class?[["class",n.class]]:[],[["href",n.renderHref(e,r)]],n.ariaHidden?[["aria-hidden","true"]]:[],Object.entries(n.renderAttrs(e,r))))}),Object.assign(new r.Token("html_inline","",0),{content:n.symbol,meta:dt}),new r.Token("link_close","a",-1)];if(n.space){var a=typeof n.space=="string"?n.space:" ";r.tokens[o+1].children[fn[n.placement]](Object.assign(new r.Token(typeof n.space=="string"?"html_inline":"text","",0),{content:a}))}(u=r.tokens[o+1].children)[fn[n.placement]].apply(u,c)});Object.assign(Ct.defaults,{space:!0,placement:"after",ariaHidden:!1});var Ue=qn(Ct.renderPermalinkImpl);Ue.defaults=Object.assign({},Ct.defaults,{ariaHidden:!0});var hu=qn(function(e,n,t,r,o){var u=[Object.assign(new r.Token("link_open","a",1),{attrs:Sr([].concat(n.class?[["class",n.class]]:[],[["href",n.renderHref(e,r)]],Object.entries(n.renderAttrs(e,r))))})].concat(n.safariReaderFix?[new r.Token("span_open","span",1)]:[],r.tokens[o+1].children,n.safariReaderFix?[new r.Token("span_close","span",-1)]:[],[new r.Token("link_close","a",-1)]);r.tokens[o+1]=Object.assign(new r.Token("inline","",0),{children:u})});Object.assign(hu.defaults,{safariReaderFix:!1});var go=qn(function(e,n,t,r,o){var u;if(!["visually-hidden","aria-label","aria-describedby","aria-labelledby"].includes(n.style))throw new Error("`permalink.linkAfterHeader` called with unknown style option `"+n.style+"`");if(!["aria-describedby","aria-labelledby"].includes(n.style)&&!n.assistiveText)throw new Error("`permalink.linkAfterHeader` called without the `assistiveText` option in `"+n.style+"` style");if(n.style==="visually-hidden"&&!n.visuallyHiddenClass)throw new Error("`permalink.linkAfterHeader` called without the `visuallyHiddenClass` option in `visually-hidden` style");var c=r.tokens[o+1].children.filter(function(l){return l.type==="text"||l.type==="code_inline"}).reduce(function(l,f){return l+f.content},""),a=[],s=[];if(n.class&&s.push(["class",n.class]),s.push(["href",n.renderHref(e,r)]),s.push.apply(s,Object.entries(n.renderAttrs(e,r))),n.style==="visually-hidden"){if(a.push(Object.assign(new r.Token("span_open","span",1),{attrs:[["class",n.visuallyHiddenClass]]}),Object.assign(new r.Token("text","",0),{content:n.assistiveText(c)}),new r.Token("span_close","span",-1)),n.space){var d=typeof n.space=="string"?n.space:" ";a[fn[n.placement]](Object.assign(new r.Token(typeof n.space=="string"?"html_inline":"text","",0),{content:d}))}a[fn[n.placement]](Object.assign(new r.Token("span_open","span",1),{attrs:[["aria-hidden","true"]]}),Object.assign(new r.Token("html_inline","",0),{content:n.symbol,meta:dt}),new r.Token("span_close","span",-1))}else a.push(Object.assign(new r.Token("html_inline","",0),{content:n.symbol,meta:dt}));n.style==="aria-label"?s.push(["aria-label",n.assistiveText(c)]):["aria-describedby","aria-labelledby"].includes(n.style)&&s.push([n.style,e]);var p=[Object.assign(new r.Token("link_open","a",1),{attrs:Sr(s)})].concat(a,[new r.Token("link_close","a",-1)]);(u=r.tokens).splice.apply(u,[o+3,0].concat(p)),n.wrapper&&(r.tokens.splice(o,0,Object.assign(new r.Token("html_block","",0),{content:n.wrapper[0]+`
`})),r.tokens.splice(o+3+p.length+1,0,Object.assign(new r.Token("html_block","",0),{content:n.wrapper[1]+`
`})))});function ko(e,n,t,r){var o=e,u=r;if(t&&Object.prototype.hasOwnProperty.call(n,o))throw new Error("User defined `id` attribute `"+e+"` is not unique. Please fix it in your Markdown to continue.");for(;Object.prototype.hasOwnProperty.call(n,o);)o=e+"-"+u,u+=1;return n[o]=!0,o}function on(e,n){n=Object.assign({},on.defaults,n),e.core.ruler.push("anchor",function(t){for(var r,o={},u=t.tokens,c=Array.isArray(n.level)?(r=n.level,function(l){return r.includes(l)}):(function(l){return function(f){return f>=l}})(n.level),a=0;a<u.length;a++){var s=u[a];if(s.type==="heading_open"&&c(Number(s.tag.substr(1)))){var d=n.getTokensText(u[a+1].children),p=s.attrGet("id");p=p==null?ko(p=n.slugifyWithState?n.slugifyWithState(d,t):n.slugify(d),o,!1,n.uniqueSlugStartIndex):ko(p,o,!0,n.uniqueSlugStartIndex),s.attrSet("id",p),n.tabIndex!==!1&&s.attrSet("tabindex",""+n.tabIndex),typeof n.permalink=="function"?n.permalink(p,n,t,a):(n.permalink||n.renderPermalink&&n.renderPermalink!==ur)&&n.renderPermalink(p,n,t,a),a=u.indexOf(s),n.callback&&n.callback(s,{slug:p,title:d})}}})}Object.assign(go.defaults,{style:"visually-hidden",space:!0,placement:"after",wrapper:null}),on.permalink={__proto__:null,legacy:ur,renderHref:du,renderAttrs:fu,makePermalink:qn,linkInsideHeader:Ct,ariaHidden:Ue,headerLink:hu,linkAfterHeader:go},on.defaults={level:1,slugify:function(e){return encodeURIComponent(String(e).trim().toLowerCase().replace(/\s+/g,"-"))},uniqueSlugStartIndex:1,tabIndex:"-1",getTokensText:function(e){return e.filter(function(n){return["text","code_inline"].includes(n.type)}).map(function(n){return n.content}).join("")},permalink:!1,renderPermalink:ur,permalinkClass:Ue.defaults.class,permalinkSpace:Ue.defaults.space,permalinkSymbol:"¶",permalinkBefore:Ue.defaults.placement==="before",permalinkHref:Ue.defaults.renderHref,permalinkAttrs:Ue.defaults.renderAttrs},on.default=on;function _t(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Ut,yo;function gl(){if(yo)return Ut;yo=1;function e(r,o){var u,c,a=r.attrs[r.attrIndex("href")][1];for(u=0;u<o.length;++u){if(c=o[u],typeof c.matcher=="function"){if(c.matcher(a,c))return c;continue}return c}}function n(r,o,u){Object.keys(u).forEach(function(c){var a,s=u[c];c==="className"&&(c="class"),a=o[r].attrIndex(c),a<0?o[r].attrPush([c,s]):o[r].attrs[a][1]=s})}function t(r,o){o?o=Array.isArray(o)?o:[o]:o=[],Object.freeze(o);var u=r.renderer.rules.link_open||this.defaultRender;r.renderer.rules.link_open=function(c,a,s,d,p){var l=e(c[a],o),f=l&&l.attrs;return f&&n(a,c,f),u(c,a,s,d,p)}}return t.defaultRender=function(r,o,u,c,a){return a.renderToken(r,o,u)},Ut=t,Ut}var kl=gl();const yl=_t(kl);function xl(e,n,t,r){const o=Number(e[n].meta.id+1).toString();let u="";return typeof r.docId=="string"&&(u=`-${r.docId}-`),u+o}function vl(e,n){let t=Number(e[n].meta.id+1).toString();return e[n].meta.subId>0&&(t+=`:${e[n].meta.subId}`),`[${t}]`}function wl(e,n,t,r,o){const u=o.rules.footnote_anchor_name(e,n,t,r,o),c=o.rules.footnote_caption(e,n,t,r,o);let a=u;return e[n].meta.subId>0&&(a+=`:${e[n].meta.subId}`),`<sup class="footnote-ref"><a href="#fn${u}" id="fnref${a}">${c}</a></sup>`}function Cl(e,n,t){return(t.xhtmlOut?`<hr class="footnotes-sep" />
`:`<hr class="footnotes-sep">
`)+`<section class="footnotes">
<ol class="footnotes-list">
`}function _l(){return`</ol>
</section>
`}function El(e,n,t,r,o){let u=o.rules.footnote_anchor_name(e,n,t,r,o);return e[n].meta.subId>0&&(u+=`:${e[n].meta.subId}`),`<li id="fn${u}" class="footnote-item">`}function Al(){return`</li>
`}function Sl(e,n,t,r,o){let u=o.rules.footnote_anchor_name(e,n,t,r,o);return e[n].meta.subId>0&&(u+=`:${e[n].meta.subId}`),` <a href="#fnref${u}" class="footnote-backref">↩︎</a>`}function Dl(e){const n=e.helpers.parseLinkLabel,t=e.utils.isSpace;e.renderer.rules.footnote_ref=wl,e.renderer.rules.footnote_block_open=Cl,e.renderer.rules.footnote_block_close=_l,e.renderer.rules.footnote_open=El,e.renderer.rules.footnote_close=Al,e.renderer.rules.footnote_anchor=Sl,e.renderer.rules.footnote_caption=vl,e.renderer.rules.footnote_anchor_name=xl;function r(a,s,d,p){const l=a.bMarks[s]+a.tShift[s],f=a.eMarks[s];if(l+4>f||a.src.charCodeAt(l)!==91||a.src.charCodeAt(l+1)!==94)return!1;let h;for(h=l+2;h<f;h++){if(a.src.charCodeAt(h)===32)return!1;if(a.src.charCodeAt(h)===93)break}if(h===l+2||h+1>=f||a.src.charCodeAt(++h)!==58)return!1;if(p)return!0;h++,a.env.footnotes||(a.env.footnotes={}),a.env.footnotes.refs||(a.env.footnotes.refs={});const b=a.src.slice(l+2,h-2);a.env.footnotes.refs[`:${b}`]=-1;const g=new a.Token("footnote_reference_open","",1);g.meta={label:b},g.level=a.level++,a.tokens.push(g);const k=a.bMarks[s],y=a.tShift[s],w=a.sCount[s],E=a.parentType,A=h,R=a.sCount[s]+h-(a.bMarks[s]+a.tShift[s]);let N=R;for(;h<f;){const U=a.src.charCodeAt(h);if(t(U))U===9?N+=4-N%4:N++;else break;h++}a.tShift[s]=h-A,a.sCount[s]=N-R,a.bMarks[s]=A,a.blkIndent+=4,a.parentType="footnote",a.sCount[s]<a.blkIndent&&(a.sCount[s]+=a.blkIndent),a.md.block.tokenize(a,s,d,!0),a.parentType=E,a.blkIndent-=4,a.tShift[s]=y,a.sCount[s]=w,a.bMarks[s]=k;const j=new a.Token("footnote_reference_close","",-1);return j.level=--a.level,a.tokens.push(j),!0}function o(a,s){const d=a.posMax,p=a.pos;if(p+2>=d||a.src.charCodeAt(p)!==94||a.src.charCodeAt(p+1)!==91)return!1;const l=p+2,f=n(a,p+1);if(f<0)return!1;if(!s){a.env.footnotes||(a.env.footnotes={}),a.env.footnotes.list||(a.env.footnotes.list=[]);const h=a.env.footnotes.list.length,b=[];a.md.inline.parse(a.src.slice(l,f),a.md,a.env,b);const g=a.push("footnote_ref","",0);g.meta={id:h},a.env.footnotes.list[h]={content:a.src.slice(l,f),tokens:b}}return a.pos=f+1,a.posMax=d,!0}function u(a,s){const d=a.posMax,p=a.pos;if(p+3>d||!a.env.footnotes||!a.env.footnotes.refs||a.src.charCodeAt(p)!==91||a.src.charCodeAt(p+1)!==94)return!1;let l;for(l=p+2;l<d;l++){if(a.src.charCodeAt(l)===32||a.src.charCodeAt(l)===10)return!1;if(a.src.charCodeAt(l)===93)break}if(l===p+2||l>=d)return!1;l++;const f=a.src.slice(p+2,l-1);if(typeof a.env.footnotes.refs[`:${f}`]>"u")return!1;if(!s){a.env.footnotes.list||(a.env.footnotes.list=[]);let h;a.env.footnotes.refs[`:${f}`]<0?(h=a.env.footnotes.list.length,a.env.footnotes.list[h]={label:f,count:0},a.env.footnotes.refs[`:${f}`]=h):h=a.env.footnotes.refs[`:${f}`];const b=a.env.footnotes.list[h].count;a.env.footnotes.list[h].count++;const g=a.push("footnote_ref","",0);g.meta={id:h,subId:b,label:f}}return a.pos=l,a.posMax=d,!0}function c(a){let s,d,p,l=!1;const f={};if(!a.env.footnotes||(a.tokens=a.tokens.filter(function(b){return b.type==="footnote_reference_open"?(l=!0,d=[],p=b.meta.label,!1):b.type==="footnote_reference_close"?(l=!1,f[":"+p]=d,!1):(l&&d.push(b),!l)}),!a.env.footnotes.list))return;const h=a.env.footnotes.list;a.tokens.push(new a.Token("footnote_block_open","",1));for(let b=0,g=h.length;b<g;b++){const k=new a.Token("footnote_open","",1);if(k.meta={id:b,label:h[b].label},a.tokens.push(k),h[b].tokens){s=[];const E=new a.Token("paragraph_open","p",1);E.block=!0,s.push(E);const A=new a.Token("inline","",0);A.children=h[b].tokens,A.content=h[b].content,s.push(A);const R=new a.Token("paragraph_close","p",-1);R.block=!0,s.push(R)}else h[b].label&&(s=f[`:${h[b].label}`]);s&&(a.tokens=a.tokens.concat(s));let y;a.tokens[a.tokens.length-1].type==="paragraph_close"?y=a.tokens.pop():y=null;const w=h[b].count>0?h[b].count:1;for(let E=0;E<w;E++){const A=new a.Token("footnote_anchor","",0);A.meta={id:b,subId:E,label:h[b].label},a.tokens.push(A)}y&&a.tokens.push(y),a.tokens.push(new a.Token("footnote_close","",-1))}a.tokens.push(new a.Token("footnote_block_close","",-1))}e.block.ruler.before("reference","footnote_def",r,{alt:["paragraph","reference"]}),e.inline.ruler.after("image","footnote_inline",o),e.inline.ruler.after("footnote_inline","footnote_ref",u),e.core.ruler.after("inline","footnote_tail",c)}var Gt,xo;function Tl(){if(xo)return Gt;xo=1;var e=!0,n=!1,t=!1;Gt=function(g,k){k&&(e=!k.enabled,n=!!k.label,t=!!k.labelAfter),g.core.ruler.after("inline","github-task-lists",function(y){for(var w=y.tokens,E=2;E<w.length;E++)u(w,E)&&(c(w[E],y.Token),r(w[E-2],"class","task-list-item"+(e?"":" enabled")),r(w[o(w,E-2)],"class","contains-task-list"))})};function r(g,k,y){var w=g.attrIndex(k),E=[k,y];w<0?g.attrPush(E):g.attrs[w]=E}function o(g,k){for(var y=g[k].level-1,w=k-1;w>=0;w--)if(g[w].level===y)return w;return-1}function u(g,k){return l(g[k])&&f(g[k-1])&&h(g[k-2])&&b(g[k])}function c(g,k){if(g.children.unshift(a(g,k)),g.children[1].content=g.children[1].content.slice(3),g.content=g.content.slice(3),n)if(t){g.children.pop();var y="task-item-"+Math.ceil(Math.random()*(1e4*1e3)-1e3);g.children[0].content=g.children[0].content.slice(0,-1)+' id="'+y+'">',g.children.push(p(g.content,y,k))}else g.children.unshift(s(k)),g.children.push(d(k))}function a(g,k){var y=new k("html_inline","",0),w=e?' disabled="" ':"";return g.content.indexOf("[ ] ")===0?y.content='<input class="task-list-item-checkbox"'+w+'type="checkbox">':(g.content.indexOf("[x] ")===0||g.content.indexOf("[X] ")===0)&&(y.content='<input class="task-list-item-checkbox" checked=""'+w+'type="checkbox">'),y}function s(g){var k=new g("html_inline","",0);return k.content="<label>",k}function d(g){var k=new g("html_inline","",0);return k.content="</label>",k}function p(g,k,y){var w=new y("html_inline","",0);return w.content='<label class="task-list-item-label" for="'+k+'">'+g+"</label>",w.attrs=[{for:k}],w}function l(g){return g.type==="inline"}function f(g){return g.type==="paragraph_open"}function h(g){return g.type==="list_item_open"}function b(g){return g.content.indexOf("[ ] ")===0||g.content.indexOf("[x] ")===0||g.content.indexOf("[X] ")===0}return Gt}var Fl=Tl();const Ml=_t(Fl),Il={note:'<svg class="octicon octicon-info mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8Zm8-6.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13ZM6.5 7.75A.75.75 0 0 1 7.25 7h1a.75.75 0 0 1 .75.75v2.75h.25a.75.75 0 0 1 0 1.5h-2a.75.75 0 0 1 0-1.5h.25v-2h-.25a.75.75 0 0 1-.75-.75ZM8 6a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z"></path></svg>',tip:'<svg class="octicon octicon-light-bulb mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M8 1.5c-2.363 0-4 1.69-4 3.75 0 .984.424 1.625.984 2.304l.214.253c.223.264.47.556.673.848.284.411.537.896.621 1.49a.75.75 0 0 1-1.484.211c-.04-.282-.163-.547-.37-.847a8.456 8.456 0 0 0-.542-.68c-.084-.1-.173-.205-.268-.32C3.201 7.75 2.5 6.766 2.5 5.25 2.5 2.31 4.863 0 8 0s5.5 2.31 5.5 5.25c0 1.516-.701 2.5-1.328 3.259-.095.115-.184.22-.268.319-.207.245-.383.453-.541.681-.208.3-.33.565-.37.847a.751.751 0 0 1-1.485-.212c.084-.593.337-1.078.621-1.489.203-.292.45-.584.673-.848.075-.088.147-.173.213-.253.561-.679.985-1.32.985-2.304 0-2.06-1.637-3.75-4-3.75ZM5.75 12h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1 0-1.5ZM6 15.25a.75.75 0 0 1 .75-.75h2.5a.75.75 0 0 1 0 1.5h-2.5a.75.75 0 0 1-.75-.75Z"></path></svg>',important:'<svg class="octicon octicon-report mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M0 1.75C0 .784.784 0 1.75 0h12.5C15.216 0 16 .784 16 1.75v9.5A1.75 1.75 0 0 1 14.25 13H8.06l-2.573 2.573A1.458 1.458 0 0 1 3 14.543V13H1.75A1.75 1.75 0 0 1 0 11.25Zm1.75-.25a.25.25 0 0 0-.25.25v9.5c0 .138.112.25.25.25h2a.75.75 0 0 1 .75.75v2.19l2.72-2.72a.749.749 0 0 1 .53-.22h6.5a.25.25 0 0 0 .25-.25v-9.5a.25.25 0 0 0-.25-.25Zm7 2.25v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 9a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path></svg>',warning:'<svg class="octicon octicon-alert mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M6.457 1.047c.659-1.234 2.427-1.234 3.086 0l6.082 11.378A1.75 1.75 0 0 1 14.082 15H1.918a1.75 1.75 0 0 1-1.543-2.575Zm1.763.707a.25.25 0 0 0-.44 0L1.698 13.132a.25.25 0 0 0 .22.368h12.164a.25.25 0 0 0 .22-.368Zm.53 3.996v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 11a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path></svg>',caution:'<svg class="octicon octicon-stop mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M4.47.22A.749.749 0 0 1 5 0h6c.199 0 .389.079.53.22l4.25 4.25c.141.14.22.331.22.53v6a.749.749 0 0 1-.22.53l-4.25 4.25A.749.749 0 0 1 11 16H5a.749.749 0 0 1-.53-.22L.22 11.53A.749.749 0 0 1 0 11V5c0-.199.079-.389.22-.53Zm.84 1.28L1.5 5.31v5.38l3.81 3.81h5.38l3.81-3.81V5.31L10.69 1.5ZM8 4a.75.75 0 0 1 .75.75v3.5a.75.75 0 0 1-1.5 0v-3.5A.75.75 0 0 1 8 4Zm0 8a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z"></path></svg>'},Rl=(e,n={})=>{const{markers:t=["TIP","NOTE","IMPORTANT","WARNING","CAUTION"],icons:r=Il,matchCaseSensitive:o=!1,titles:u={},classPrefix:c="markdown-alert"}=n,a=t==="*"?"\\w+":t.join("|"),s=new RegExp(`^\\\\?\\[\\!(${a})\\]([^\\n\\r]*)`,o?"":"i");e.core.ruler.after("block","github-alerts",d=>{const p=d.tokens;for(let l=0;l<p.length;l++)if(p[l].type==="blockquote_open"){const f=p[l],h=l;for(;p[l]?.type!=="blockquote_close"&&l<=p.length;)l+=1;const b=p[l],g=l,k=p.slice(h,g+1).find(R=>R.type==="inline");if(!k)continue;const y=k.content.match(s);if(!y)continue;const w=y[1].toLowerCase(),E=y[2].trim()||(u[w]??Ll(w)),A=r[w]??"";k.content=k.content.slice(y[0].length).trimStart(),f.type="alert_open",f.tag="div",f.meta={title:E,type:w,icon:A},b.type="alert_close",b.tag="div"}}),e.renderer.rules.alert_open=function(d,p){const{title:l,type:f,icon:h}=d[p].meta;return`<div class="${c} ${c}-${f}"><p class="${c}-title">${h}${l}</p>`}};function Ll(e){return e.charAt(0).toUpperCase()+e.slice(1)}var Nl=Object.create,pu=Object.defineProperty,Ol=Object.getOwnPropertyDescriptor,Pl=Object.getOwnPropertyNames,Bl=Object.getPrototypeOf,zl=Object.prototype.hasOwnProperty,Z=(e,n)=>()=>(n||(e((n={exports:{}}).exports,n),e=null),n.exports),ql=(e,n,t,r)=>{if(n&&typeof n=="object"||typeof n=="function")for(var o=Pl(n),u=0,c=o.length,a;u<c;u++)a=o[u],!zl.call(e,a)&&a!==t&&pu(e,a,{get:(s=>n[s]).bind(null,a),enumerable:!(r=Ol(n,a))||r.enumerable});return e},Hl=(e,n,t)=>(t=e!=null?Nl(Bl(e)):{},ql(pu(t,"default",{value:e,enumerable:!0}),e)),Hn=Z(((e,n)=>{function t(s){return typeof s>"u"||s===null}function r(s){return typeof s=="object"&&s!==null}function o(s){return Array.isArray(s)?s:t(s)?[]:[s]}function u(s,d){if(d){const p=Object.keys(d);for(let l=0,f=p.length;l<f;l+=1){const h=p[l];s[h]=d[h]}}return s}function c(s,d){let p="";for(let l=0;l<d;l+=1)p+=s;return p}function a(s){return s===0&&Number.NEGATIVE_INFINITY===1/s}n.exports.isNothing=t,n.exports.isObject=r,n.exports.toArray=o,n.exports.repeat=c,n.exports.isNegativeZero=a,n.exports.extend=u})),jn=Z(((e,n)=>{function t(o,u){let c="";const a=o.reason||"(unknown reason)";return o.mark?(o.mark.name&&(c+='in "'+o.mark.name+'" '),c+="("+(o.mark.line+1)+":"+(o.mark.column+1)+")",!u&&o.mark.snippet&&(c+=`

`+o.mark.snippet),a+" "+c):a}function r(o,u){Error.call(this),this.name="YAMLException",this.reason=o,this.mark=u,this.message=t(this,!1),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=new Error().stack||""}r.prototype=Object.create(Error.prototype),r.prototype.constructor=r,r.prototype.toString=function(u){return this.name+": "+t(this,u)},n.exports=r})),jl=Z(((e,n)=>{var t=Hn();function r(c,a,s,d,p){let l="",f="";const h=Math.floor(p/2)-1;return d-a>h&&(l=" ... ",a=d-h+l.length),s-d>h&&(f=" ...",s=d+h-f.length),{str:l+c.slice(a,s).replace(/\t/g,"→")+f,pos:d-a+l.length}}function o(c,a){return t.repeat(" ",a-c.length)+c}function u(c,a){if(a=Object.create(a||null),!c.buffer)return null;a.maxLength||(a.maxLength=79),typeof a.indent!="number"&&(a.indent=1),typeof a.linesBefore!="number"&&(a.linesBefore=3),typeof a.linesAfter!="number"&&(a.linesAfter=2);const s=/\r?\n|\r|\0/g,d=[0],p=[];let l,f=-1;for(;l=s.exec(c.buffer);)p.push(l.index),d.push(l.index+l[0].length),c.position<=l.index&&f<0&&(f=d.length-2);f<0&&(f=d.length-1);let h="";const b=Math.min(c.line+a.linesAfter,p.length).toString().length,g=a.maxLength-(a.indent+b+3);for(let y=1;y<=a.linesBefore&&!(f-y<0);y++){const w=r(c.buffer,d[f-y],p[f-y],c.position-(d[f]-d[f-y]),g);h=t.repeat(" ",a.indent)+o((c.line-y+1).toString(),b)+" | "+w.str+`
`+h}const k=r(c.buffer,d[f],p[f],c.position,g);h+=t.repeat(" ",a.indent)+o((c.line+1).toString(),b)+" | "+k.str+`
`,h+=t.repeat("-",a.indent+b+3+k.pos)+`^
`;for(let y=1;y<=a.linesAfter&&!(f+y>=p.length);y++){const w=r(c.buffer,d[f+y],p[f+y],c.position-(d[f]-d[f+y]),g);h+=t.repeat(" ",a.indent)+o((c.line+y+1).toString(),b)+" | "+w.str+`
`}return h.replace(/\n$/,"")}n.exports=u})),ue=Z(((e,n)=>{var t=jn(),r=["kind","multi","resolve","construct","instanceOf","predicate","represent","representName","defaultStyle","styleAliases"],o=["scalar","sequence","mapping"];function u(a){const s={};return a!==null&&Object.keys(a).forEach(function(d){a[d].forEach(function(p){s[String(p)]=d})}),s}function c(a,s){if(s=s||{},Object.keys(s).forEach(function(d){if(r.indexOf(d)===-1)throw new t('Unknown option "'+d+'" is met in definition of "'+a+'" YAML type.')}),this.options=s,this.tag=a,this.kind=s.kind||null,this.resolve=s.resolve||function(){return!0},this.construct=s.construct||function(d){return d},this.instanceOf=s.instanceOf||null,this.predicate=s.predicate||null,this.represent=s.represent||null,this.representName=s.representName||null,this.defaultStyle=s.defaultStyle||null,this.multi=s.multi||!1,this.styleAliases=u(s.styleAliases||null),o.indexOf(this.kind)===-1)throw new t('Unknown kind "'+this.kind+'" is specified for "'+a+'" YAML type.')}n.exports=c})),mu=Z(((e,n)=>{var t=jn(),r=ue();function o(a,s){const d=[];return a[s].forEach(function(p){let l=d.length;d.forEach(function(f,h){f.tag===p.tag&&f.kind===p.kind&&f.multi===p.multi&&(l=h)}),d[l]=p}),d}function u(){const a={scalar:{},sequence:{},mapping:{},fallback:{},multi:{scalar:[],sequence:[],mapping:[],fallback:[]}};function s(d){d.multi?(a.multi[d.kind].push(d),a.multi.fallback.push(d)):a[d.kind][d.tag]=a.fallback[d.tag]=d}for(let d=0,p=arguments.length;d<p;d+=1)arguments[d].forEach(s);return a}function c(a){return this.extend(a)}c.prototype.extend=function(s){let d=[],p=[];if(s instanceof r)p.push(s);else if(Array.isArray(s))p=p.concat(s);else if(s&&(Array.isArray(s.implicit)||Array.isArray(s.explicit)))s.implicit&&(d=d.concat(s.implicit)),s.explicit&&(p=p.concat(s.explicit));else throw new t("Schema.extend argument should be a Type, [ Type ], or a schema definition ({ implicit: [...], explicit: [...] })");d.forEach(function(f){if(!(f instanceof r))throw new t("Specified list of YAML types (or a single Type object) contains a non-Type object.");if(f.loadKind&&f.loadKind!=="scalar")throw new t("There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.");if(f.multi)throw new t("There is a multi type in the implicit list of a schema. Multi tags can only be listed as explicit.")}),p.forEach(function(f){if(!(f instanceof r))throw new t("Specified list of YAML types (or a single Type object) contains a non-Type object.")});const l=Object.create(c.prototype);return l.implicit=(this.implicit||[]).concat(d),l.explicit=(this.explicit||[]).concat(p),l.compiledImplicit=o(l,"implicit"),l.compiledExplicit=o(l,"explicit"),l.compiledTypeMap=u(l.compiledImplicit,l.compiledExplicit),l},n.exports=c})),bu=Z(((e,n)=>{n.exports=new(ue())("tag:yaml.org,2002:str",{kind:"scalar",construct:function(t){return t!==null?t:""}})})),gu=Z(((e,n)=>{n.exports=new(ue())("tag:yaml.org,2002:seq",{kind:"sequence",construct:function(t){return t!==null?t:[]}})})),ku=Z(((e,n)=>{n.exports=new(ue())("tag:yaml.org,2002:map",{kind:"mapping",construct:function(t){return t!==null?t:{}}})})),yu=Z(((e,n)=>{n.exports=new(mu())({explicit:[bu(),gu(),ku()]})})),xu=Z(((e,n)=>{var t=ue();function r(c){if(c===null)return!0;const a=c.length;return a===1&&c==="~"||a===4&&(c==="null"||c==="Null"||c==="NULL")}function o(){return null}function u(c){return c===null}n.exports=new t("tag:yaml.org,2002:null",{kind:"scalar",resolve:r,construct:o,predicate:u,represent:{canonical:function(){return"~"},lowercase:function(){return"null"},uppercase:function(){return"NULL"},camelcase:function(){return"Null"},empty:function(){return""}},defaultStyle:"lowercase"})})),vu=Z(((e,n)=>{var t=ue();function r(c){if(c===null)return!1;const a=c.length;return a===4&&(c==="true"||c==="True"||c==="TRUE")||a===5&&(c==="false"||c==="False"||c==="FALSE")}function o(c){return c==="true"||c==="True"||c==="TRUE"}function u(c){return Object.prototype.toString.call(c)==="[object Boolean]"}n.exports=new t("tag:yaml.org,2002:bool",{kind:"scalar",resolve:r,construct:o,predicate:u,represent:{lowercase:function(c){return c?"true":"false"},uppercase:function(c){return c?"TRUE":"FALSE"},camelcase:function(c){return c?"True":"False"}},defaultStyle:"lowercase"})})),wu=Z(((e,n)=>{var t=Hn(),r=ue();function o(l){return l>=48&&l<=57||l>=65&&l<=70||l>=97&&l<=102}function u(l){return l>=48&&l<=55}function c(l){return l>=48&&l<=57}function a(l){if(l===null)return!1;const f=l.length;let h=0,b=!1;if(!f)return!1;let g=l[h];if((g==="-"||g==="+")&&(g=l[++h]),g==="0"){if(h+1===f)return!0;if(g=l[++h],g==="b"){for(h++;h<f;h++){if(g=l[h],g!=="0"&&g!=="1")return!1;b=!0}return b&&Number.isFinite(s(l))}if(g==="x"){for(h++;h<f;h++){if(!o(l.charCodeAt(h)))return!1;b=!0}return b&&Number.isFinite(s(l))}if(g==="o"){for(h++;h<f;h++){if(!u(l.charCodeAt(h)))return!1;b=!0}return b&&Number.isFinite(s(l))}}for(;h<f;h++){if(!c(l.charCodeAt(h)))return!1;b=!0}return b?Number.isFinite(s(l)):!1}function s(l){let f=l,h=1,b=f[0];if((b==="-"||b==="+")&&(b==="-"&&(h=-1),f=f.slice(1),b=f[0]),f==="0")return 0;if(b==="0"){if(f[1]==="b")return h*parseInt(f.slice(2),2);if(f[1]==="x")return h*parseInt(f.slice(2),16);if(f[1]==="o")return h*parseInt(f.slice(2),8)}return h*parseInt(f,10)}function d(l){return s(l)}function p(l){return Object.prototype.toString.call(l)==="[object Number]"&&l%1===0&&!t.isNegativeZero(l)}n.exports=new r("tag:yaml.org,2002:int",{kind:"scalar",resolve:a,construct:d,predicate:p,represent:{binary:function(l){return l>=0?"0b"+l.toString(2):"-0b"+l.toString(2).slice(1)},octal:function(l){return l>=0?"0o"+l.toString(8):"-0o"+l.toString(8).slice(1)},decimal:function(l){return l.toString(10)},hexadecimal:function(l){return l>=0?"0x"+l.toString(16).toUpperCase():"-0x"+l.toString(16).toUpperCase().slice(1)}},defaultStyle:"decimal",styleAliases:{binary:[2,"bin"],octal:[8,"oct"],decimal:[10,"dec"],hexadecimal:[16,"hex"]}})})),Cu=Z(((e,n)=>{var t=Hn(),r=ue(),o=new RegExp("^(?:[-+]?(?:[0-9]+)(?:\\.[0-9]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$"),u=new RegExp("^(?:[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");function c(l){return l===null||!o.test(l)?!1:Number.isFinite(parseFloat(l,10))?!0:u.test(l)}function a(l){let f=l.toLowerCase();const h=f[0]==="-"?-1:1;return"+-".indexOf(f[0])>=0&&(f=f.slice(1)),f===".inf"?h===1?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY:f===".nan"?NaN:h*parseFloat(f,10)}var s=/^[-+]?[0-9]+e/;function d(l,f){if(isNaN(l))switch(f){case"lowercase":return".nan";case"uppercase":return".NAN";case"camelcase":return".NaN"}else if(Number.POSITIVE_INFINITY===l)switch(f){case"lowercase":return".inf";case"uppercase":return".INF";case"camelcase":return".Inf"}else if(Number.NEGATIVE_INFINITY===l)switch(f){case"lowercase":return"-.inf";case"uppercase":return"-.INF";case"camelcase":return"-.Inf"}else if(t.isNegativeZero(l))return"-0.0";const h=l.toString(10);return s.test(h)?h.replace("e",".e"):h}function p(l){return Object.prototype.toString.call(l)==="[object Number]"&&(l%1!==0||t.isNegativeZero(l))}n.exports=new r("tag:yaml.org,2002:float",{kind:"scalar",resolve:c,construct:a,predicate:p,represent:d,defaultStyle:"lowercase"})})),_u=Z(((e,n)=>{n.exports=yu().extend({implicit:[xu(),vu(),wu(),Cu()]})})),Eu=Z(((e,n)=>{n.exports=_u()})),Au=Z(((e,n)=>{var t=ue(),r=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),o=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");function u(s){return s===null?!1:r.exec(s)!==null||o.exec(s)!==null}function c(s){let d=0,p=null,l=r.exec(s);if(l===null&&(l=o.exec(s)),l===null)throw new Error("Date resolve error");const f=+l[1],h=+l[2]-1,b=+l[3];if(!l[4])return new Date(Date.UTC(f,h,b));const g=+l[4],k=+l[5],y=+l[6];if(l[7]){for(d=l[7].slice(0,3);d.length<3;)d+="0";d=+d}if(l[9]){const E=+l[10],A=+(l[11]||0);p=(E*60+A)*6e4,l[9]==="-"&&(p=-p)}const w=new Date(Date.UTC(f,h,b,g,k,y,d));return p&&w.setTime(w.getTime()-p),w}function a(s){return s.toISOString()}n.exports=new t("tag:yaml.org,2002:timestamp",{kind:"scalar",resolve:u,construct:c,instanceOf:Date,represent:a})})),Su=Z(((e,n)=>{var t=ue();function r(o){return o==="<<"||o===null}n.exports=new t("tag:yaml.org,2002:merge",{kind:"scalar",resolve:r})})),Du=Z(((e,n)=>{var t=ue(),r=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;function o(s){if(s===null)return!1;let d=0;const p=s.length,l=r;for(let f=0;f<p;f++){const h=l.indexOf(s.charAt(f));if(!(h>64)){if(h<0)return!1;d+=6}}return d%8===0}function u(s){const d=s.replace(/[\r\n=]/g,""),p=d.length,l=r;let f=0;const h=[];for(let g=0;g<p;g++)g%4===0&&g&&(h.push(f>>16&255),h.push(f>>8&255),h.push(f&255)),f=f<<6|l.indexOf(d.charAt(g));const b=p%4*6;return b===0?(h.push(f>>16&255),h.push(f>>8&255),h.push(f&255)):b===18?(h.push(f>>10&255),h.push(f>>2&255)):b===12&&h.push(f>>4&255),new Uint8Array(h)}function c(s){let d="",p=0;const l=s.length,f=r;for(let b=0;b<l;b++)b%3===0&&b&&(d+=f[p>>18&63],d+=f[p>>12&63],d+=f[p>>6&63],d+=f[p&63]),p=(p<<8)+s[b];const h=l%3;return h===0?(d+=f[p>>18&63],d+=f[p>>12&63],d+=f[p>>6&63],d+=f[p&63]):h===2?(d+=f[p>>10&63],d+=f[p>>4&63],d+=f[p<<2&63],d+=f[64]):h===1&&(d+=f[p>>2&63],d+=f[p<<4&63],d+=f[64],d+=f[64]),d}function a(s){return Object.prototype.toString.call(s)==="[object Uint8Array]"}n.exports=new t("tag:yaml.org,2002:binary",{kind:"scalar",resolve:o,construct:u,predicate:a,represent:c})})),Tu=Z(((e,n)=>{var t=ue(),r=Object.prototype.hasOwnProperty,o=Object.prototype.toString;function u(a){if(a===null)return!0;const s=[],d=a;for(let p=0,l=d.length;p<l;p+=1){const f=d[p];let h=!1;if(o.call(f)!=="[object Object]")return!1;let b;for(b in f)if(r.call(f,b))if(!h)h=!0;else return!1;if(!h)return!1;if(s.indexOf(b)===-1)s.push(b);else return!1}return!0}function c(a){return a!==null?a:[]}n.exports=new t("tag:yaml.org,2002:omap",{kind:"sequence",resolve:u,construct:c})})),Fu=Z(((e,n)=>{var t=ue(),r=Object.prototype.toString;function o(c){if(c===null)return!0;const a=c,s=new Array(a.length);for(let d=0,p=a.length;d<p;d+=1){const l=a[d];if(r.call(l)!=="[object Object]")return!1;const f=Object.keys(l);if(f.length!==1)return!1;s[d]=[f[0],l[f[0]]]}return!0}function u(c){if(c===null)return[];const a=c,s=new Array(a.length);for(let d=0,p=a.length;d<p;d+=1){const l=a[d],f=Object.keys(l);s[d]=[f[0],l[f[0]]]}return s}n.exports=new t("tag:yaml.org,2002:pairs",{kind:"sequence",resolve:o,construct:u})})),Mu=Z(((e,n)=>{var t=ue(),r=Object.prototype.hasOwnProperty;function o(c){if(c===null)return!0;const a=c;for(const s in a)if(r.call(a,s)&&a[s]!==null)return!1;return!0}function u(c){return c!==null?c:{}}n.exports=new t("tag:yaml.org,2002:set",{kind:"mapping",resolve:o,construct:u})})),Dr=Z(((e,n)=>{n.exports=Eu().extend({implicit:[Au(),Su()],explicit:[Du(),Tu(),Fu(),Mu()]})})),$l=Z(((e,n)=>{var t=Hn(),r=jn(),o=jl(),u=Dr(),c=Object.prototype.hasOwnProperty,a=1,s=2,d=3,p=4,l=1,f=2,h=3,b=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,g=/[\x85\u2028\u2029]/,k=/[,\[\]{}]/,y=/^(?:!|!!|![0-9A-Za-z-]+!)$/,w=/^(?:!|[^,\[\]{}])(?:%[0-9a-f]{2}|[0-9a-z\-#;/?:@&=+$,_.!~*'()\[\]])*$/i;function E(i){return Object.prototype.toString.call(i)}function A(i){return i===10||i===13}function R(i){return i===9||i===32}function N(i){return i===9||i===32||i===10||i===13}function j(i){return i===44||i===91||i===93||i===123||i===125}function U(i){if(i>=48&&i<=57)return i-48;const x=i|32;return x>=97&&x<=102?x-97+10:-1}function Q(i){return i===120?2:i===117?4:i===85?8:0}function se(i){return i>=48&&i<=57?i-48:-1}function Ce(i){switch(i){case 48:return"\0";case 97:return"\x07";case 98:return"\b";case 116:return"	";case 9:return"	";case 110:return`
`;case 118:return"\v";case 102:return"\f";case 114:return"\r";case 101:return"\x1B";case 32:return" ";case 34:return'"';case 47:return"/";case 92:return"\\";case 78:return"";case 95:return" ";case 76:return"\u2028";case 80:return"\u2029";default:return""}}function kn(i){return i<=65535?String.fromCharCode(i):String.fromCharCode((i-65536>>10)+55296,(i-65536&1023)+56320)}function ze(i,x,_){x==="__proto__"?Object.defineProperty(i,x,{configurable:!0,enumerable:!0,writable:!0,value:_}):i[x]=_}var qe=new Array(256),de=new Array(256);for(let i=0;i<256;i++)qe[i]=Ce(i)?1:0,de[i]=Ce(i);function X(i,x){this.input=i,this.filename=x.filename||null,this.schema=x.schema||u,this.onWarning=x.onWarning||null,this.legacy=x.legacy||!1,this.json=x.json||!1,this.listener=x.listener||null,this.maxDepth=typeof x.maxDepth=="number"?x.maxDepth:100,this.maxMergeSeqLength=typeof x.maxMergeSeqLength=="number"?x.maxMergeSeqLength:20,this.implicitTypes=this.schema.compiledImplicit,this.typeMap=this.schema.compiledTypeMap,this.length=i.length,this.position=0,this.line=0,this.lineStart=0,this.lineIndent=0,this.depth=0,this.firstTabInLine=-1,this.documents=[],this.anchorMapTransactions=[]}function Gn(i,x){const _={name:i.filename,buffer:i.input.slice(0,-1),position:i.position,line:i.line,column:i.position-i.lineStart};return _.snippet=o(_),new r(x,_)}function z(i,x){throw Gn(i,x)}function Je(i,x){i.onWarning&&i.onWarning.call(null,Gn(i,x))}function _e(i,x,_){const T=i.anchorMapTransactions;if(T.length!==0){const C=T[T.length-1];c.call(C,x)||(C[x]={existed:c.call(i.anchorMap,x),value:i.anchorMap[x]})}i.anchorMap[x]=_}function Ft(i){i.anchorMapTransactions.push(Object.create(null))}function He(i){const x=i.anchorMapTransactions.pop(),_=i.anchorMapTransactions;if(_.length===0)return;const T=_[_.length-1],C=Object.keys(x);for(let L=0,m=C.length;L<m;L+=1){const v=C[L];c.call(T,v)||(T[v]=x[v])}}function Mt(i){const x=i.anchorMapTransactions.pop(),_=Object.keys(x);for(let T=_.length-1;T>=0;T-=1){const C=x[_[T]];C.existed?i.anchorMap[_[T]]=C.value:delete i.anchorMap[_[T]]}}function yn(i){return{position:i.position,line:i.line,lineStart:i.lineStart,lineIndent:i.lineIndent,firstTabInLine:i.firstTabInLine,tag:i.tag,anchor:i.anchor,kind:i.kind,result:i.result}}function Qe(i,x){i.position=x.position,i.line=x.line,i.lineStart=x.lineStart,i.lineIndent=x.lineIndent,i.firstTabInLine=x.firstTabInLine,i.tag=x.tag,i.anchor=x.anchor,i.kind=x.kind,i.result=x.result}var Vn={YAML:function(x,_,T){x.version!==null&&z(x,"duplication of %YAML directive"),T.length!==1&&z(x,"YAML directive accepts exactly one argument");const C=/^([0-9]+)\.([0-9]+)$/.exec(T[0]);C===null&&z(x,"ill-formed argument of the YAML directive");const L=parseInt(C[1],10),m=parseInt(C[2],10);L!==1&&z(x,"unacceptable YAML version of the document"),x.version=T[0],x.checkLineBreaks=m<2,m!==1&&m!==2&&Je(x,"unsupported YAML version of the document")},TAG:function(x,_,T){let C;T.length!==2&&z(x,"TAG directive accepts exactly two arguments");const L=T[0];C=T[1],y.test(L)||z(x,"ill-formed tag handle (first argument) of the TAG directive"),c.call(x.tagMap,L)&&z(x,'there is a previously declared suffix for "'+L+'" tag handle'),w.test(C)||z(x,"ill-formed tag prefix (second argument) of the TAG directive");try{C=decodeURIComponent(C)}catch{z(x,"tag prefix is malformed: "+C)}x.tagMap[L]=C}};function ae(i,x,_,T){if(x<_){const C=i.input.slice(x,_);if(T)for(let L=0,m=C.length;L<m;L+=1){const v=C.charCodeAt(L);v===9||v>=32&&v<=1114111||z(i,"expected valid JSON character")}else b.test(C)&&z(i,"the stream contains non-printable characters");i.result+=C}}function Me(i,x,_,T){t.isObject(_)||z(i,"cannot merge mappings; the provided source object is unacceptable");const C=Object.keys(_);for(let L=0,m=C.length;L<m;L+=1){const v=C[L];c.call(x,v)||(ze(x,v,_[v]),T[v]=!0)}}function Ee(i,x,_,T,C,L,m,v,I){if(Array.isArray(C)){C=Array.prototype.slice.call(C);for(let S=0,D=C.length;S<D;S+=1)Array.isArray(C[S])&&z(i,"nested arrays are not supported inside keys"),typeof C=="object"&&E(C[S])==="[object Object]"&&(C[S]="[object Object]")}if(typeof C=="object"&&E(C)==="[object Object]"&&(C="[object Object]"),C=String(C),x===null&&(x={}),T==="tag:yaml.org,2002:merge")if(Array.isArray(L)){L.length>i.maxMergeSeqLength&&z(i,"merge sequence length exceeded maxMergeSeqLength ("+i.maxMergeSeqLength+")");const S=new Set;for(let D=0,M=L.length;D<M;D+=1){const F=L[D];S.has(F)||(S.add(F),Me(i,x,F,_))}}else Me(i,x,L,_);else!i.json&&!c.call(_,C)&&c.call(x,C)&&(i.line=m||i.line,i.lineStart=v||i.lineStart,i.position=I||i.position,z(i,"duplicated mapping key")),ze(x,C,L),delete _[C];return x}function Xe(i){const x=i.input.charCodeAt(i.position);x===10?i.position++:x===13?(i.position++,i.input.charCodeAt(i.position)===10&&i.position++):z(i,"a line break is expected"),i.line+=1,i.lineStart=i.position,i.firstTabInLine=-1}function Y(i,x,_){let T=0,C=i.input.charCodeAt(i.position);for(;C!==0;){for(;R(C);)C===9&&i.firstTabInLine===-1&&(i.firstTabInLine=i.position),C=i.input.charCodeAt(++i.position);if(x&&C===35)do C=i.input.charCodeAt(++i.position);while(C!==10&&C!==13&&C!==0);if(A(C))for(Xe(i),C=i.input.charCodeAt(i.position),T++,i.lineIndent=0;C===32;)i.lineIndent++,C=i.input.charCodeAt(++i.position);else break}return _!==-1&&T!==0&&i.lineIndent<_&&Je(i,"deficient indentation"),T}function en(i){let x=i.position,_=i.input.charCodeAt(x);return!!((_===45||_===46)&&_===i.input.charCodeAt(x+1)&&_===i.input.charCodeAt(x+2)&&(x+=3,_=i.input.charCodeAt(x),_===0||N(_)))}function Ae(i,x){x===1?i.result+=" ":x>1&&(i.result+=t.repeat(`
...
`)}const be=pe(us,{html:!0,breaks:!0,linkify:!0,...is}),Is=[];be.use(Yl());be.use(on);be.use(yl,{matcher:e=>!e.startsWith("#"),attrs:{target:"_blank",rel:"noopener"}});be.use(Dl);be.use(Ml,{enabled:Mr(),label:!0});be.use(Rl);const Rs=new Set(["paragraph_open","heading_open","blockquote_open","list_item_open","bullet_list_open","ordered_list_open","fence","code_block","table_open","html_block","front_matter"]),Ls=Promise.all(Is).then(()=>{for(const e of Rs){const n=be.renderer.rules[e];be.renderer.rules[e]=(t,r,o,u,c)=>{const a=t[r];return u.lineInfo&&a.map?.length===2&&(a.attrSet("data-line-from",String(a.map[0])),a.attrSet("data-line-to",String(a.map[1]-1))),n?n(t,r,o,u,c):c.renderToken(t,r,o)}}for(const e of["fence","code_block"]){const n=be.renderer.rules[e];be.renderer.rules[e]=(t,r,o,u,c)=>`
      ...
      </div>`}}),Ns=new DOMParser,Os="image-loader",Rr="cm-md-image-preview",Co=5;function ju(e){const n=Ns.parseFromString(e,"text/html");return n.querySelectorAll("img").forEach(r=>{const o=r.getAttribute("src");o!==null&&(o.includes("://")||o.startsWith("data:image/")||(r.src=`${Os}://${o}`))}),n.body.innerHTML}function Ps(e){typeof B.MarkEdit.getFileInfo=="function"&&(document.addEventListener("mousemove",n=>{Ne.panelPresenter!==void 0&&(clearTimeout(Ne.panelPresenter),Ne.panelPresenter=void 0),Ne.panelPresenter=setTimeout(()=>{const t=n.target,r=t?.closest(".cm-md-link"),o=r?.dataset.linkUrl??r?.innerText??"";r!==null&&Ti(o)?Bs(r,o):t?.classList.contains(Rr)||En()},600)}),document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&En(!1)}),e.addEventListener("scroll",()=>En()))}async function Bs(e,n){if(e===Ne.focusedElement)return;const t=(await B.MarkEdit.getFileInfo())?.parentPath;if(t===void 0)return;const r=rn(t,n),o=await B.MarkEdit.getFileObject(r);if(o===void 0)return;const u=e.getBoundingClientRect(),c=document.createElement("img");c.className=Rr,c.style.position="fixed",c.style.left=`${u.left}px`,c.style.zIndex="10000",c.style.borderRadius="5px",c.style.opacity="0",c.style.transition="opacity 120ms",c.style.cursor="pointer",c.onclick=()=>{En(),window.open(n,"_blank")},c.onload=()=>{const s=Math.min(c.naturalHeight,240);c.style.height=`${s}px`;const d=u.top,p=window.innerHeight-u.bottom;d>p?c.style.top=`${u.top-s-Co}px`:c.style.top=`${u.bottom+Co}px`,requestAnimationFrame(()=>{c.style.opacity="1"})};const a=o.mimeType??"image/png";c.src=`data:${a};base64,${o.data}`,En(!1),Ne.focusedElement=e,document.body.appendChild(c)}function En(e=!0){Ne.focusedElement!==void 0&&(Ne.focusedElement=void 0,document.querySelectorAll(`.${Rr}`).forEach(n=>{e?(n.style.opacity="0",n.addEventListener("transitionend",()=>n.remove(),{once:!0})):n.remove()}))}const Ne={panelPresenter:void 0,focusedElement:void 0};let Ln=null,ar=null;function Lr(){Ln=null,ar=null}function $u(e){Ln===null&&(Ln=Array.from(e.querySelectorAll("[data-line-from]")).map(n=>({from:parseInt(n.dataset.lineFrom??"0",10),to:parseInt(n.dataset.lineTo??"0",10),el:n,top:ct(e,n)})))}function zs(e){return Ln===null&&$u(e),Ln??[]}function qs(e){return ar??=parseFloat(getComputedStyle(e).paddingTop)||0,ar}let ht=null,Wt;function _o(e){ht=e,Wt!==void 0&&clearTimeout(Wt),Wt=setTimeout(()=>{ht=null},150)}function Hs(e,n){if(!ts)return;let t,r;e.addEventListener("scroll",()=>{ht!=="preview"&&(wd()||(t!==void 0&&cancelAnimationFrame(t),t=requestAnimationFrame(()=>{_o("editor"),cr(e,n,!1)})))},{passive:!0}),n.addEventListener("scroll",()=>{ht!=="editor"&&(r!==void 0&&cancelAnimationFrame(r),r=requestAnimationFrame(()=>{_o("preview"),js(n,e)}))},{passive:!0})}function cr(e,n,t=!0){const{line:r,progress:o}=$s(e);Us(n,r,o,t)}function js(e,n){const t=zs(e);if(t.length===0)return;const r=e.scrollTop,o=qs(e);let u=0,c=t.length-1,a,s=0;for(;u<=c;){const y=u+c>>>1,w=t[y].top-o;if(w+t[y].el.offsetHeight<=r)u=y+1;else if(y>0&&t[y-1].top-o+t[y-1].el.offsetHeight>r)c=y-1;else{a=t[y],s=At((r-w)/t[y].el.offsetHeight);break}}if(a===void 0)return;const{from:d,to:p}=a,l=d+Math.round(s*Math.max(0,p-d)),f=B.MarkEdit.editorView,h=Math.max(1,Math.min(f.state.doc.lines,l+1)),b=f.state.doc.line(h),g=f.lineBlockAt(b.from),k=g.top+g.height*(s%1);n.scrollTo({top:k,behavior:"instant"})}function $s(e,n=0){const t=B.MarkEdit.editorView,r=t.lineBlockAtHeight(e.scrollTop+n),o=t.state.doc.lineAt(r.from).number-1,u=r.height>0?At((e.scrollTop-r.top)/r.height):0;return{line:o,progress:u}}function Us(e,n,t,r=!0){if(n===0&&t===0)return it(e,0,r);const o=Array.from(document.querySelectorAll("[data-line-from]")),u=Gs(o,n);if(u!==void 0){const{from:s,to:d}=an(u);return Ot(e,u,Zs(n,t,s,d),r)}if(n===0)return it(e,0,r);const{beforeBlock:c,afterBlock:a}=Vs(o,n);if(c!==void 0&&a!==void 0){const s=an(c),d=an(a),p=ct(e,c)+c.offsetHeight,l=ct(e,a),f=d.from-s.to,h=n-s.to+t,b=f>0?At(h/f):0;return it(e,p+(l-p)*b,r)}if(c!==void 0)return Ot(e,c,1,r);if(a!==void 0)return Ot(e,a,0,r)}function Gs(e,n){let t=0,r=e.length-1;for(;t<=r;){const o=t+r>>>1,{from:u,to:c}=an(e[o]);if(n<u)r=o-1;else if(n>c)t=o+1;else return e[o]}}function Vs(e,n){let t,r;for(const o of e){const{from:u,to:c}=an(o);if(c<n)t=o;else if(u>n){r=o;break}}return{beforeBlock:t,afterBlock:r}}function Zs(e,n,t,r){const o=r-t;return o<1?e===t?n:0:At((e-t+n)/o)}function At(e){return Math.max(0,Math.min(1,e))}function Ws(e){const n=e.match(/^((?:\s{0,3}>\s*)*\s*(?:[-*+]|\d+[.)])\s+\[)([ xX])\](?= )/);return n===null?null:{offset:n[1].length,replacement:n[2]===" "?"x":" "}}function Ks(e){for(var n=1;n<arguments.length;n++){var t=arguments[n];for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&(e[r]=t[r])}return e}function lr(e,n){return Array(n+1).join(e)}function Uu(e){return e.replace(/^\n*/,"")}function Gu(e){for(var n=e.length;n>0&&e[n-1]===`
`;)n--;return e.substring(0,n)}function Vu(e){return Gu(Uu(e))}var Ys=["ADDRESS","ARTICLE","ASIDE","AUDIO","BLOCKQUOTE","BODY","CANVAS","CENTER","DD","DIR","DIV","DL","DT","FIELDSET","FIGCAPTION","FIGURE","FOOTER","FORM","FRAMESET","H1","H2","H3","H4","H5","H6","HEADER","HGROUP","HR","HTML","ISINDEX","LI","MAIN","MENU","NAV","NOFRAMES","NOSCRIPT","OL","OUTPUT","P","PRE","SECTION","TABLE","TBODY","TD","TFOOT","TH","THEAD","TR","UL"];function Nr(e){return Or(e,Ys)}var Zu=["AREA","BASE","BR","COL","COMMAND","EMBED","HR","IMG","INPUT","KEYGEN","LINK","META","PARAM","SOURCE","TRACK","WBR"];function Wu(e){return Or(e,Zu)}function Js(e){return Yu(e,Zu)}var Ku=["A","TABLE","THEAD","TBODY","TFOOT","TH","TD","IFRAME","SCRIPT","AUDIO","VIDEO"];function Qs(e){return Or(e,Ku)}function Xs(e){return Yu(e,Ku)}function Or(e,n){return n.indexOf(e.nodeName)>=0}function Yu(e,n){return e.getElementsByTagName&&n.some(function(t){return e.getElementsByTagName(t).length})}var e0=[[/\\/g,"\\\\"],[/\*/g,"\\*"],[/^-/g,"\\-"],[/^\+ /g,"\\+ "],[/^(=+)/g,"\\$1"],[/^(#{1,6}) /g,"\\$1 "],[/`/g,"\\`"],[/^~~~/g,"\\~~~"],[/\[/g,"\\["],[/\]/g,"\\]"],[/^>/g,"\\>"],[/_/g,"\\_"],[/^(\d+)\. /g,"$1\\. "]];function Ju(e){return e0.reduce(function(n,t){return n.replace(t[0],t[1])},e)}var oe={};oe.paragraph={filter:"p",replacement:function(e){return`

`+e+`

`}};oe.lineBreak={filter:"br",replacement:function(e,n,t){return t.br+`
`}};oe.heading={filter:["h1","h2","h3","h4","h5","h6"],replacement:function(e,n,t){var r=Number(n.nodeName.charAt(1));if(t.headingStyle==="setext"&&r<3){var o=lr(r===1?"=":"-",e.length);return`
...
`}};oe.blockquote={filter:"blockquote",replacement:function(e){return e=Vu(e).replace(/^/gm,"> "),`

`+e+`

`}};oe.list={filter:["ul","ol"],replacement:function(e,n){var t=n.parentNode;return t.nodeName==="LI"&&t.lastElementChild===n?`
`+e:`

`+e+`

`}};oe.listItem={filter:"li",replacement:function(e,n,t){var r=t.bulletListMarker+"   ",o=n.parentNode;if(o.nodeName==="OL"){var u=o.getAttribute("start"),c=Array.prototype.indexOf.call(o.children,n);r=(u?Number(u)+c:c+1)+".  "}var a=/\n$/.test(e);return e=Vu(e)+(a?`
`:""),e=e.replace(/\n/gm,`
`+" ".repeat(r.length)),r+e+(n.nextSibling?`
`:"")}};oe.indentedCodeBlock={filter:function(e,n){return n.codeBlockStyle==="indented"&&e.nodeName==="PRE"&&e.firstChild&&e.firstChild.nodeName==="CODE"},replacement:function(e,n,t){return`

    `+n.firstChild.textContent.replace(/\n/g,`
    `)+`

`}};oe.fencedCodeBlock={filter:function(e,n){return n.codeBlockStyle==="fenced"&&e.nodeName==="PRE"&&e.firstChild&&e.firstChild.nodeName==="CODE"},replacement:function(e,n,t){for(var r=n.firstChild.getAttribute("class")||"",o=(r.match(/language-(\S+)/)||[null,""])[1],u=n.firstChild.textContent,c=t.fence.charAt(0),a=3,s=new RegExp("^"+c+"{3,}","gm"),d;d=s.exec(u);)d[0].length>=a&&(a=d[0].length+1);var p=lr(c,a);return`

`+p+o+`
`+u.replace(/\n$/,"")+`
`+p+`

`}};oe.horizontalRule={filter:"hr",replacement:function(e,n,t){return`

`+t.hr+`

`}};oe.inlineLink={filter:function(e,n){return n.linkStyle==="inlined"&&e.nodeName==="A"&&e.getAttribute("href")},replacement:function(e,n){var t=Pr(n.getAttribute("href")),r=Br(pt(n.getAttribute("title"))),o=r?' "'+r+'"':"";return"["+e+"]("+t+o+")"}};oe.referenceLink={filter:function(e,n){return n.linkStyle==="referenced"&&e.nodeName==="A"&&e.getAttribute("href")},replacement:function(e,n,t){var r=Pr(n.getAttribute("href")),o=pt(n.getAttribute("title"));o&&(o=' "'+Br(o)+'"');var u,c;switch(t.linkReferenceStyle){case"collapsed":u="["+e+"][]",c="["+e+"]: "+r+o;break;case"shortcut":u="["+e+"]",c="["+e+"]: "+r+o;break;default:var a=this.references.length+1;u="["+e+"]["+a+"]",c="["+a+"]: "+r+o}return this.references.push(c),u},references:[],append:function(e){var n="";return this.references.length&&(n=`

`+this.references.join(`
`)+`

`,this.references=[]),n}};oe.emphasis={filter:["em","i"],replacement:function(e,n,t){return e.trim()?t.emDelimiter+e+t.emDelimiter:""}};oe.strong={filter:["strong","b"],replacement:function(e,n,t){return e.trim()?t.strongDelimiter+e+t.strongDelimiter:""}};oe.code={filter:function(e){var n=e.previousSibling||e.nextSibling,t=e.parentNode.nodeName==="PRE"&&!n;return e.nodeName==="CODE"&&!t},replacement:function(e){if(!e)return"";e=e.replace(/\r?\n|\r/g," ");for(var n=/^`|^ .*?[^ ].* $|`$/.test(e)?" ":"",t="`",r=e.match(/`+/gm)||[];r.indexOf(t)!==-1;)t=t+"`";return t+n+e+n+t}};oe.image={filter:"img",replacement:function(e,n){var t=Ju(pt(n.getAttribute("alt"))),r=Pr(n.getAttribute("src")||""),o=pt(n.getAttribute("title")),u=o?' "'+Br(o)+'"':"";return r?"!["+t+"]("+r+u+")":""}};function pt(e){return e?e.replace(/(\n+\s*)+/g,`
`):""}function Pr(e){var n=e.replace(/([<>()])/g,"\\$1");return n.indexOf(" ")>=0?"<"+n+">":n}function Br(e){return e.replace(/"/g,'\\"')}function Qu(e){this.options=e,this._keep=[],this._remove=[],this.blankRule={replacement:e.blankReplacement},this.keepReplacement=e.keepReplacement,this.defaultRule={replacement:e.defaultReplacement},this.array=[];for(var n in e.rules)this.array.push(e.rules[n])}Qu.prototype={add:function(e,n){this.array.unshift(n)},keep:function(e){this._keep.unshift({filter:e,replacement:this.keepReplacement})},remove:function(e){this._remove.unshift({filter:e,replacement:function(){return""}})},forNode:function(e){if(e.isBlank)return this.blankRule;var n;return(n=Kt(this.array,e,this.options))||(n=Kt(this._keep,e,this.options))||(n=Kt(this._remove,e,this.options))?n:this.defaultRule},forEach:function(e){for(var n=0;n<this.array.length;n++)e(this.array[n],n)}};function Kt(e,n,t){for(var r=0;r<e.length;r++){var o=e[r];if(n0(o,n,t))return o}}function n0(e,n,t){var r=e.filter;if(typeof r=="string"){if(r===n.nodeName.toLowerCase())return!0}else if(Array.isArray(r)){if(r.indexOf(n.nodeName.toLowerCase())>-1)return!0}else if(typeof r=="function"){if(r.call(e,n,t))return!0}else throw new TypeError("`filter` needs to be a string, array, or function")}function t0(e){var n=e.element,t=e.isBlock,r=e.isVoid,o=e.isPre||function(l){return l.nodeName==="PRE"};if(!(!n.firstChild||o(n))){for(var u=null,c=!1,a=null,s=Eo(a,n,o);s!==n;){if(s.nodeType===3||s.nodeType===4){var d=s.data.replace(/[ \r\n\t]+/g," ");if((!u||/ $/.test(u.data))&&!c&&d[0]===" "&&(d=d.substr(1)),!d){s=Yt(s);continue}s.data=d,u=s}else if(s.nodeType===1)t(s)||s.nodeName==="BR"?(u&&(u.data=u.data.replace(/ $/,"")),u=null,c=!1):r(s)||o(s)?(u=null,c=!0):u&&(c=!1);else{s=Yt(s);continue}var p=Eo(a,s,o);a=s,s=p}u&&(u.data=u.data.replace(/ $/,""),u.data||Yt(u))}}function Yt(e){var n=e.nextSibling||e.parentNode;return e.parentNode.removeChild(e),n}function Eo(e,n,t){return e&&e.parentNode===n||t(n)?n.nextSibling||n.parentNode:n.firstChild||n.nextSibling||n.parentNode}var zr=typeof window<"u"?window:{};function r0(){var e=zr.DOMParser,n=!1;try{new e().parseFromString("","text/html")&&(n=!0)}catch{}return n}function o0(){var e=function(){};return u0()?e.prototype.parseFromString=function(n){var t=new window.ActiveXObject("htmlfile");return t.designMode="on",t.open(),t.write(n),t.close(),t}:e.prototype.parseFromString=function(n){var t=document.implementation.createHTMLDocument("");return t.open(),t.write(n),t.close(),t},e}function u0(){var e=!1;try{document.implementation.createHTMLDocument("").open()}catch{zr.ActiveXObject&&(e=!0)}return e}var i0=r0()?zr.DOMParser:o0();function a0(e,n){var t;if(typeof e=="string"){var r=c0().parseFromString('<x-turndown id="turndown-root">'+e+"</x-turndown>","text/html");t=r.getElementById("turndown-root")}else t=e.cloneNode(!0);return t0({element:t,isBlock:Nr,isVoid:Wu,isPre:n.preformattedCode?l0:null}),t}var Jt;function c0(){return Jt=Jt||new i0,Jt}function l0(e){return e.nodeName==="PRE"||e.nodeName==="CODE"}function s0(e,n){return e.isBlock=Nr(e),e.isCode=e.nodeName==="CODE"||e.parentNode.isCode,e.isBlank=d0(e),e.flankingWhitespace=f0(e,n),e}function d0(e){return!Wu(e)&&!Qs(e)&&/^\s*$/i.test(e.textContent)&&!Js(e)&&!Xs(e)}function f0(e,n){if(e.isBlock||n.preformattedCode&&e.isCode)return{leading:"",trailing:""};var t=h0(e.textContent);return t.leadingAscii&&Ao("left",e,n)&&(t.leading=t.leadingNonAscii),t.trailingAscii&&Ao("right",e,n)&&(t.trailing=t.trailingNonAscii),{leading:t.leading,trailing:t.trailing}}function h0(e){var n=e.match(/^(([ \t\r\n]*)(\s*))(?:(?=\S)[\s\S]*\S)?((\s*?)([ \t\r\n]*))$/);return{leading:n[1],leadingAscii:n[2],leadingNonAscii:n[3],trailing:n[4],trailingNonAscii:n[5],trailingAscii:n[6]}}function Ao(e,n,t){var r,o,u;return e==="left"?(r=n.previousSibling,o=/ $/):(r=n.nextSibling,o=/^ /),r&&(r.nodeType===3?u=o.test(r.nodeValue):t.preformattedCode&&r.nodeName==="CODE"?u=!1:r.nodeType===1&&!Nr(r)&&(u=o.test(r.textContent))),u}var p0=Array.prototype.reduce;function mt(e){if(!(this instanceof mt))return new mt(e);var n={rules:oe,headingStyle:"setext",hr:"* * *",bulletListMarker:"*",codeBlockStyle:"indented",fence:"```",emDelimiter:"_",strongDelimiter:"**",linkStyle:"inlined",linkReferenceStyle:"full",br:"  ",preformattedCode:!1,blankReplacement:function(t,r){return r.isBlock?`
...
`:t}};this.options=Ks({},n,e),this.rules=new Qu(this.options)}mt.prototype={turndown:function(e){if(!g0(e))throw new TypeError(e+" is not a string, or an element/document/fragment node.");if(e==="")return"";var n=Xu.call(this,new a0(e,this.options));return m0.call(this,n)},use:function(e){if(Array.isArray(e))for(var n=0;n<e.length;n++)this.use(e[n]);else if(typeof e=="function")e(this);else throw new TypeError("plugin must be a Function or an Array of Functions");return this},addRule:function(e,n){return this.rules.add(e,n),this},keep:function(e){return this.rules.keep(e),this},remove:function(e){return this.rules.remove(e),this},escape:function(e){return Ju(e)}};function Xu(e){var n=this;return p0.call(e.childNodes,function(t,r){r=new s0(r,n.options);var o="";return r.nodeType===3?o=r.isCode?r.nodeValue:n.escape(r.nodeValue):r.nodeType===1&&(o=b0.call(n,r)),ei(t,o)},"")}function m0(e){var n=this;return this.rules.forEach(function(t){typeof t.append=="function"&&(e=ei(e,t.append(n.options)))}),e.replace(/^[\t\r\n]+/,"").replace(/[\t\r\n\s]+$/,"")}function b0(e){var n=this.rules.forNode(e),t=Xu.call(this,e),r=e.flankingWhitespace;return(r.leading||r.trailing)&&(t=t.trim()),r.leading+n.replacement(t,e,this.options)+r.trailing}function ei(e,n){var t=Gu(e),r=Uu(n),o=Math.max(e.length-t.length,n.length-r.length),u=`

`.substring(0,o);return t+u+r}function g0(e){return e!=null&&(typeof e=="string"||e.nodeType&&(e.nodeType===1||e.nodeType===9||e.nodeType===11))}var So=/highlight-(?:text|source)-([a-z0-9]+)/;function k0(e){e.addRule("highlightedCodeBlock",{filter:function(n){var t=n.firstChild;return n.nodeName==="DIV"&&So.test(n.className)&&t&&t.nodeName==="PRE"},replacement:function(n,t,r){var o=t.className||"",u=(o.match(So)||[null,""])[1];return`

`+r.fence+u+`
`+t.firstChild.textContent+`
`+r.fence+`

`}})}function y0(e){e.addRule("strikethrough",{filter:["del","s","strike"],replacement:function(n){return"~"+n+"~"}})}var x0=Array.prototype.indexOf,v0=Array.prototype.every,hn={};hn.tableCell={filter:["th","td"],replacement:function(e,n){return ni(e,n)}};hn.tableRow={filter:"tr",replacement:function(e,n){var t="",r={left:":--",right:"--:",center:":-:"};if(qr(n))for(var o=0;o<n.childNodes.length;o++){var u="---",c=(n.childNodes[o].getAttribute("align")||"").toLowerCase();c&&(u=r[c]||u),t+=ni(u,n.childNodes[o])}return`
`+e+(t?`
...
`,gt=document.body,An=document.createElement("div"),K=document.createElement("div"),Fo=Ie("* { cursor: col-resize }",!1),pi=he.Annotation.define();var fe=(e=>(e[e.edit=0]="edit",e[e.sideBySide=1]="sideBySide",e[e.preview=2]="preview",e))(fe||{});function yd(){Ie(bd),Ie(Pu()),Ie(Bu()),Ie(zu()),Ie(gd),Ie(kd);const e=document.createElement("div");e.className=Ze.dividerViewClass,An.appendChild(e),An.className=Ze.gutterViewClass,gt.appendChild(An),K.className=Ze.previewPaneClass,gt.appendChild(K),document.addEventListener("keydown",r=>{if(!r.metaKey||r.key!=="a")return;const o=B.MarkEdit.editorView?.contentDOM??document.querySelector(".cm-content");(K.classList.contains("overlay")||document.activeElement!==o)&&(Di(K),r.preventDefault())}),new MutationObserver(Mo).observe(K,{attributes:!0,attributeFilter:["style","class"]}),matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{Mo(),document.querySelector(".mermaid")!==null&&On()}),typeof B.MarkEdit.getFileInfo=="function"&&typeof B.MarkEdit.openFile=="function"&&K.addEventListener("click",Fd),K.addEventListener("click",Md)}function Un(e,n=!0){const t=le();Oe.viewMode=e,e!==t&&localStorage.setItem(Dt.viewModeCacheKey,String(e));const r=B.MarkEdit.editorView;e===0?r.focus():e===2&&r.contentDOM.blur(),e===1?(gt.classList.add(Ze.containerClass),Oe.splitter??=md({columnGutters:[{track:1,element:An}],minSize:150,onDragStart:()=>Fo.disabled=!1,onDragEnd:()=>Fo.disabled=!0})):(gt.classList.remove(Ze.containerClass),Oe.splitter?.destroy(),Oe.splitter=void 0),e===2?K.classList.add("overlay"):K.classList.remove("overlay"),n&&On()}function xd(){const e=[0,...os.map(r=>{switch(r){case"side-by-side":return 1;case"preview":return 2;default:return}}).filter(r=>r!==void 0)],n=e.indexOf(le()),t=n===-1?0:(n+1)%e.length;Un(e[t])}function vd(){const e=localStorage.getItem(Dt.viewModeCacheKey);if(e===null)return;const n=Number(e);le()!==n&&Un(n,!0)}function le(){return Oe.viewMode}function dr(e){Oe.wysiwygEditLock=e}function wd(){return Oe.wysiwygEditLock}async function On(){if(Oe.wysiwygEditLock||le()===0)return;const e=Ur()?K.scrollTop:void 0,n=ju(await Tt());K.innerHTML=n,Lr(),requestAnimationFrame(()=>{$u(K),e!==void 0?K.scrollTop=e:cr(fr(),K,!1)}),qu(()=>{e===void 0&&cr(fr(),Be(),!1);const t=localStorage.getItem(Dt.previewPageZoomKey);t!==null&&(K.style.zoom=t)})}function Cd(e){if(le()===0||le()===1&&B.MarkEdit.editorView.hasFocus||!e.metaKey||e.ctrlKey||e.altKey||e.shiftKey)return;const n=Number(K.style.zoom)||1,t=r=>String(Math.min(Math.max(r,.5),3));switch(e.key){case"-":K.style.zoom=t(n-.1);break;case"=":K.style.zoom=t(n+.1);break;case"0":K.style.zoom="1";break;default:return}localStorage.setItem(Dt.previewPageZoomKey,K.style.zoom),e.preventDefault(),e.stopPropagation()}function _d(){mi(!1)}async function Ed(){const n=(await Gr(!0)).replace("</body>",'<script>window.addEventListener("load",()=>{window.print();});window.addEventListener("afterprint",()=>{window.close();});<\/script></body>'),o=B.MarkEdit.getDirectoryPath("home").replace(/\/Library\/Containers\/[^/]+\/Data\/?$/,"")+"/.markedit-print.html";if(!await B.MarkEdit.createFile({path:o,string:n,overwrites:!0})){await B.MarkEdit.showSavePanel({string:n,fileName:"print-rendered.html"});return}await B.MarkEdit.runService("Open URL","file://"+o)}function Ad(){mi(!0)}async function Sd(){const e=await Tt(!1);await navigator.clipboard.writeText(e)}async function Dd(){const e=await Tt(!1),n=new ClipboardItem({"text/html":new Blob([e],{type:"text/html"}),"text/plain":new Blob([K.innerText],{type:"text/plain"})});await navigator.clipboard.write([n])}function fr(){return B.MarkEdit.editorView.scrollDOM}function Be(){return K}async function Gr(e){const n=await Tt(!1);return e?await Hu(n):`<meta charset="UTF-8">
${n}`}async function Td(e,n){const t=await Ir(e,!1);return n?await Hu(t):`<meta charset="UTF-8">
${t}`}async function Tt(e=!0){const n=B.MarkEdit.editorAPI.getText();return await Ir(n,e)}function Mo(){const e=getComputedStyle(K).backgroundColor;An.style.background=`linear-gradient(to right, transparent 50%, ${e} 50%)`}async function mi(e){const n=await(async()=>{const r=await B.MarkEdit.getFileInfo();return r===void 0?`${G("untitled")}.html`:`${Si(r.filePath)}.html`})(),t=await Gr(e);B.MarkEdit.showSavePanel({fileName:n,string:t})}async function Fd(e){if(!(e.target instanceof Element))return;const n=e.target.closest("a");if(n===null)return;const t=n.getAttribute("href");if(!t?.startsWith("../"))return;const r=(await B.MarkEdit.getFileInfo())?.parentPath;if(r!==void 0){e.preventDefault(),e.stopPropagation();try{const o=rn(r,decodeURIComponent(t));await B.MarkEdit.openFile(o)}catch(o){console.error("Failed to open file:",o)}}}function Md(e){const n=e.target;if(!(n instanceof HTMLInputElement)||!n.classList.contains("task-list-item-checkbox"))return;const t=n.closest("[data-line-from]");if(t===null){console.error("Failed to find task item block");return}const r=B.MarkEdit.editorAPI,o=r.getLineRange(an(t).from),u=Ws(r.getText(o));if(u===null){n.checked=!n.checked,console.error("Failed to resolve task toggle");return}const c=o.from+u.offset;B.MarkEdit.editorView.dispatch({changes:{from:c,to:c+1,insert:u.replacement},annotations:pi.of(!0)})}const Oe={viewMode:0,splitter:void 0,wysiwygEditLock:!1};async function hr(){if(_n==="never")return;const e=await bi();typeof e.tag_name=="string"&&e.name!=="1.9.0"&&(yi().has(e.name)||(_n==="automatic"&&kr()?await Vr(e.tag_name):_n==="quiet"?(pr.pendingRelease=e,gi(e)):Rd(e)))}async function Id(){const e=Date.now(),n=Number(localStorage.getItem(mn.lastCheckCacheKey)??"0");if(!(e-n<2592e5))try{await hr(),localStorage.setItem(mn.lastCheckCacheKey,String(e))}catch(t){console.error("Failed to check for updates:",t)}}async function bi(){return await(await fetch(mn.latestReleaseURL)).json()}async function Vr(e){if(typeof __FILE_PATH__!="string")return console.error("Cannot download the latest build: unknown file path"),!1;try{const n=__FILE_PATH__,t="lite/",r=e===void 0?"main":`refs/tags/${encodeURIComponent(e)}`,o=`${mn.rawBaseURL}${r}/dist/${t}markedit-preview.js`,u=await fetch(o);if(!u.ok)return console.error(`Failed to download the latest build from ${o}`),!1;const c=await u.text();return await B.MarkEdit.createFile({path:n,string:c,overwrites:!0})}catch(n){return console.error("Failed to download the latest build:",n),!1}}function gi(e=pr.pendingRelease){if(e===void 0)return;const n=document.querySelector(`.${Ze.updatePillClass}`);if(n!==null){if(n.dataset.releaseName===e.name)return n;n.remove()}const t=document.createElement("button");return t.dataset.releaseName=e.name,t.className=Ze.updatePillClass,t.textContent=G("update"),t.style.display=le()===fe.edit?"none":"",t.addEventListener("webkitmouseforcedown",r=>{r.preventDefault()}),t.addEventListener("click",()=>{const{title:r,actions:o}=ki(e,()=>{pr.pendingRelease=void 0,t.remove()}),[u,...c]=o,a=t.getBoundingClientRect(),s={x:a.left,y:a.bottom+10};B.MarkEdit.showContextMenu([{title:r},u,{separator:!0},...c],s)}),document.body.appendChild(t),t}async function Rd(e){const{title:n,actions:t}=ki(e),r=await B.MarkEdit.showAlert({title:n,message:e.body,buttons:t.map(o=>o.title)});t[r]?.action?.()}function ki(e,n=()=>{}){const t=`MarkEdit-preview ${e.name} ${G("newVersionAvailable")}`,r=[...kr()?[{title:G("updateAndRelaunch"),action:async()=>{await Vr(e.tag_name)?B.MarkEdit.relaunchApp():B.MarkEdit.showAlert(G("failedToUpdate")),n()}}]:[],{title:G("viewReleasePage"),action:()=>{open(e.html_url),n()}},{title:G("remindMeLater"),action:n},{title:G("skipThisVersion"),action:()=>{const o=yi();o.add(e.name),localStorage.setItem(mn.skippedCacheKey,JSON.stringify([...o])),n()}}];return{title:t,actions:r}}function yi(){const e=localStorage.getItem(mn.skippedCacheKey);return new Set(JSON.parse(e??"[]"))}const mn={latestReleaseURL:"https://api.github.com/repos/MarkEdit-app/MarkEdit-preview/releases/latest",rawBaseURL:"https://raw.githubusercontent.com/MarkEdit-app/MarkEdit-preview/",lastCheckCacheKey:"updater.last-check-time",skippedCacheKey:"updater.skipped-versions"},pr={pendingRelease:void 0},mr="markedit-preview",Io=`${mr}.js`;function Ld(e){const{destExists:n,bundleInfo:t,currentVersion:r}=e,o=t?.version===r,u=t?.fullBuild===!1;return!(n&&o&&u)}async function Nd(){try{const e=B.MarkEdit.getDirectoryPath("documents"),n=B.MarkEdit.getDirectoryPath("sharedContainer");if(e===void 0||n===void 0){console.error("Required directories are not accessible");return}const t=typeof __FILE_PATH__=="string"?__FILE_PATH__:rn(e,`scripts/${Io}`);if(await B.MarkEdit.getFileInfo(t)===void 0){console.error(`Source file not found at ${t}`);return}const o=t.split("/").pop()??Io,u=rn(n,"Shared/scripts"),c=rn(u,o),a=await B.MarkEdit.getFileInfo(c)!==void 0,s=rn(n,"Shared/metadata.json"),d=await Fi(s),p=d[mr];if(!Ld({destExists:a,bundleInfo:p,currentVersion:"1.9.0"}))return;const l=await B.MarkEdit.getFileContent(t);if(l===void 0){console.error(`Failed to read content from ${t}`);return}await B.MarkEdit.createFile({path:u,isDirectory:!0}),await B.MarkEdit.createFile({path:c,string:l,overwrites:!0}),await B.MarkEdit.createFile({path:s,string:JSON.stringify({...d,[mr]:{version:"1.9.0",fullBuild:!1}},null,2),overwrites:!0})}catch(e){console.error("Failed to copy the current file to shared container:",e)}}const Od='<svg viewBox="0 0 16 16" aria-hidden="true"><g transform="translate(0 -0.5)"><path d="M6.2 2.5 4.4 13.5M11.6 2.5 9.8 13.5M2.5 5.7h11M2.5 10.3h11" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></g></svg>',Pd='<svg viewBox="0 0 16 16" aria-hidden="true"><g transform="translate(0 -0.5)"><path d="M1 8c2-3.5 4.5-5 7-5s5 1.5 7 5c-2 3.5-4.5 5-7 5s-5-1.5-7-5Z" fill="none" stroke="currentColor" stroke-width="1.5"/><circle cx="8" cy="8" r="2" fill="currentColor"/></g></svg>';function Bd(){const e=Ro(G("source"),Od),n=Ro(G("preview"),Pd),t=document.createElement("div");t.className="quicklook-segmented",t.setAttribute("role","tablist"),t.append(e,n);const r=document.createElement("div");return r.className="quicklook-toolbar",r.appendChild(t),{toolbar:r,sourceButton:e,previewButton:n}}function Ro(e,n){const t=document.createElement("button");t.title=e,t.type="button",t.className="quicklook-segment",t.setAttribute("role","tab"),t.setAttribute("aria-label",e);const r=document.createElement("span");r.textContent=e,r.className="quicklook-segment-label";const o=document.createElement("span");return o.innerHTML=n,o.className="quicklook-segment-icon",t.append(r,o),t}function nn(){if(tn!==void 0)return tn;try{tn=localStorage.getItem(xi)==="source"?"source":"preview"}catch{console.error("Failed to read quick look mode from localStorage"),tn="preview"}return tn}function Lo(e){tn=e;try{localStorage.setItem(xi,e)}catch{console.error("Failed to write quick look mode to localStorage")}}let tn;const xi="ui.quicklook-mode";function zd(){const e=window,n=e.editor?.state?.doc.toString();return typeof n=="string"?n:(console.error("Failed to get text from host editor state"),e.config?.text??"")}function qd(){document.addEventListener("webkitmouseforcewillbegin",e=>{const n=e.target;n instanceof Element&&n.closest("a")!==null&&e.preventDefault()})}function Hd(e,n){const t=window,r=t.pinchZoomTarget;t.pinchZoomTarget=()=>{if(e()!=="preview")return r?.()??null;const o=n.querySelector(".quicklook-content");return o!==null?{scroller:n,inner:o}:null};for(const o of["gesturechange","gestureend"])document.addEventListener(o,()=>{if(e()!=="preview")return;const u=n.querySelector(".quicklook-content");u?.style.zoom.length?u?.style.setProperty("--quicklook-zoom",u.style.zoom):u?.style.removeProperty("--quicklook-zoom")},{passive:!1})}function jd(e,n){let t;const r=window,o={start:r.startDragging,update:r.updateDragging,cancel:r.cancelDragging},u=()=>{const a=n.clientHeight,s=n.scrollHeight,d=s-a;if(d<=0||s<=0)return{clientHeight:a,scrollHeight:s,scrollbarHeight:a,scrollbarTop:0};const p=a*(a/s),f=n.scrollTop/d*(a-p);return{clientHeight:a,scrollHeight:s,scrollbarHeight:p,scrollbarTop:f}},c=(a,s,d="auto")=>{const{clientHeight:p,scrollHeight:l,scrollbarHeight:f}=u(),h=p-f;if(h>0){const b=(a-s)/h;n.scrollTo({top:b*(l-p),behavior:d})}};r.startDragging=a=>{if(e()!=="preview"){o.start?.(a);return}const{scrollbarTop:s,scrollbarHeight:d}=u(),p=No(n,a);t=p-s,(p<s||p>s+d)&&c(p,d*.5,"smooth")},r.updateDragging=a=>{if(e()!=="preview"){o.update?.(a);return}t!==void 0&&c(No(n,a),t)},r.cancelDragging=()=>{if(e()!=="preview"){o.cancel?.();return}t=void 0}}function $d(e,n,t){t.addEventListener("wheel",r=>{const o=e()==="preview"?n:document.querySelector(".cm-scroller");o!==null&&(o.scrollTop+=r.deltaY,o.scrollLeft+=r.deltaX,r.preventDefault())},{passive:!1})}function Ud(e,n,t){const r=document.querySelector(".cm-scroller"),o=()=>{const c=(e()==="preview"?n:r)?.scrollTop??0;t.classList.toggle("scrolled",c>0),t.classList.toggle("scrolled-far",c>20)};return n.addEventListener("scroll",o,{passive:!0}),r?.addEventListener("scroll",o,{passive:!0}),o}function Gd(e){document.addEventListener("copy",n=>{if(!e.classList.contains("overlay"))return;const t=getSelection(),r=t!==null&&t.rangeCount>0?t.getRangeAt(0):null,o=r!==null&&!r.collapsed&&e.contains(r.commonAncestorContainer)?r:null,u=o??(()=>{const a=document.createRange();return a.selectNodeContents(e),a})(),c=document.createElement("div");c.appendChild(u.cloneContents()),n.clipboardData?.setData("text/html",c.innerHTML),n.clipboardData?.setData("text/plain",o!==null?o.toString():e.innerText),n.preventDefault(),n.stopPropagation()},!0)}function No(e,n){return n-e.getBoundingClientRect().top}const Vd=`body {
